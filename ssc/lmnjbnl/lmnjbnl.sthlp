{smcl}
{hline}
{cmd:help: {helpb lmnjbnl}}{space 50} {cmd:dialog:} {bf:{dialog lmnjbnl}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf: lmnjbnl: NLS Non Normality Jarque-Bera Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmnjbnl##01:Syntax}{p_end}
{p 5}{helpb lmnjbnl##02:Options}{p_end}
{p 5}{helpb lmnjbnl##03:Description}{p_end}
{p 5}{helpb lmnjbnl##04:Saved Results}{p_end}
{p 5}{helpb lmnjbnl##05:References}{p_end}

{p 1}*** {helpb lmnjbnl##06:Examples}{p_end}

{p 5}{helpb lmnjbnl##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 3 5 6}
{cmd:lmnjbnl} {depvar} {ifin} {weight} , {opt fun(expression)}{p_end} 
{p 5 5 6}
...
{pstd}
{cmd:lmnjbnl} computes Non Linear Least Squares Non Normality Jarque-Bera Test.
...
{pstd}
{cmd:lmnjbnl} saves the following in {cmd:e()}:
...
{stata sysuse lmnjbnl.dta , clear}

{stata gen ly=ln(y)}

{stata "lmnjbnl ly , fun({B0}+{B1}*k+{B2}*l)"}

{stata "lmnjbnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5)"}
{hline}
...
==============================================================================
*** NLS Non Normality Jarque-Bera Test
==============================================================================
 Ho: Normality - Ha: Non Normality
------------------------------------------------------------------------------
*** Non Normality Tests:
- Jarque-Bera LM Test                  =   1.7198     P-Value > Chi2(2) 0.4232
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMNJBNL Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2012)}{p_end}
{p 1 10 1}{cmd:LMNJBNL: "NLS Non Normality Jarque-Bera Test"}{p_end}
