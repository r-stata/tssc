...
program define lmharch2 , eclass byable(onecall)
version 11.2
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** 2SLS-IV Heteroscedasticity Engle (ARCH) Test - Model= ({bf:{err:`model'}})}}"
di _dup(78) "{bf:{err:=}}"
