{smcl}
{hline}
{cmd:help: {helpb lmnadxt}}{space 50} {cmd:dialog:} {bf:{dialog lmnadxt}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmnadxt: Panel Data Non Normality Anderson-Darling Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmnadxt##01:Syntax}{p_end}
{p 5}{helpb lmnadxt##02:Options}{p_end}
{p 5}{helpb lmnadxt##03:Description}{p_end}
{p 5}{helpb lmnadxt##04:Saved Results}{p_end}
{p 5}{helpb lmnadxt##05:References}{p_end}

{p 1}*** {helpb lmnadxt##06:Examples}{p_end}

{p 5}{helpb lmnadxt##07:Authors}{p_end}

{p2colreset}{...}
{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{opt lmnadxt} {depvar} {indepvars} {ifin} , {bf:{err:id(var)}} {bf:{err:it(var)}} {err: [} {opt nocons:tant} {opt cross} {opt coll} {err:]}{p_end}
...
{p 2 2 2} {cmd:lmnadxt} computes Panel Data Non Normality Anderson-Darling Test.
...
{p 2 4 2 }{cmd:lmnadxt} saves the following results in {cmd:e()}:
...
{marker 06}{bf:{err:{dlgtab:Examples}}}
  ...
  {stata sysuse lmnadxt.dta, clear}

  {stata db lmnadxt}

  {stata lmnadxt y x1 x2 , id(id) it(t)}
{hline}

. clear all
. sysuse lmnadxt.dta, clear
. lmnadxt y x1 x2 , id(id) it(t)
...
==============================================================================
*** Panel Data Non Normality Anderson-Darling Test
==============================================================================
 Ho: Normality - Ha: Non Normality
------------------------------------------------------------------------------
- Anderson-Darling Z Test              =   0.3279     P > Z( 0.090)     0.5360
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMNADXT Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2013)}{p_end}
{p 1 10 1}{cmd:LMNADXT: "Panel Data Non Normality Anderson-Darling Test"}{p_end}
