*! abar 1.1.5 11 May 2017

* Version history
* 1.1.5 Fixed typo in warning message
...
program define abar, rclass
	...
	local id `r(panelvar)'
	if "`id'" == "" {
		noi di as res "Warning: The Arellano-Bond test is only valid for time series if they are ergodic."
	}
