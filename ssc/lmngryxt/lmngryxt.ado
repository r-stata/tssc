...
program define lmngryxt, eclass 
version 11.2
...
tempvar Bw D DE DF1 DW E e dcs TimeN EE idv itv LE P Q SSE Wi Wio WS X X0 Bo
tempvar SST Time tm U U2 Ue wald weit Yho Yt YY YYm YYv Yh_ML Ue_ML Z
tempvar Xb XB Xo XQ Yb Yh Yh2 Yhb D DE DF DF1 E E2 E3 E4 LDE LE P Q Sig2 SSE
tempvar uiv Xb XB Yb Yh Yh2 Yhb Yho YY Z M N NC NT P Phi Pm Q Sig21 Sig2o
tempname A B b Beta Bx Cov D den DF Dim Dx E E1 eVec IPhi J K kb kx llf
tempname SSE SSEo SST1 SST2 Ue_ML Vec Vs W W1 W2 Wald waldm We Wi 
tempname V Wi1 Wio WS WW WY X X0 XB Y Yh Yh_ML YYm YYv Z
qui xtset `id' `it'
...
qui replace `Time'=_n if `touse'
 local N=`N'
tempvar E DE LDE LDF1 
tempname Eb Sk Ku N1 N2 EN S2N SN Rn Lower Upper sksd kusd
qui tsset `Time'
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** Panel Data Non Normality Geary Runs Test}}"
di _dup(78) "{bf:{err:=}}"
