...
{p2colset 5 18 20 2}{...}
{p2col :{hi:clrbound} {hline 2}}Compute a one-sided bound estimate{p_end}
{p2colreset}{...}

{title:Syntax}
{p 8 17 2}
{cmdab:clr:bound (}{it:depvar1 indepvars1 range1})
...
{pstd}{cmd:clrbound} estimates the one-sided lower or upper intersection bounds of a parameter. The variables are defined similarly as for {cmd:clr2bound}; see {help clr2bound}. {cmd:clrbound} requires the package {cmd:moremata}.
