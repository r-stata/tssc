#delim ;
prog def cprdhes_primary_diag_hosp;
version 13.0;
*
 Create dataset with 1 obs per primary diagnosis per hospital spell
...
cap lab var icd_primary "Primary ICD10 diagnosis code";
