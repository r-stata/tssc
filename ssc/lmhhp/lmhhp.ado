...
tempvar DE DF1 E E2 EE Eo Wi ht L LDE LE LnE2 LYh LYh2 SSE Time wald weit
tempvar Wio WS X0 Yb Yh Yh2 Yhb Yho YY YYm YYv Yh_ML Ue_ML TimeN
tempname b B Beta Bx Cov D E E1 Eo F IPhi J K OM P Phi Pm Q S X X0
tempname Sig2 Sig2o Sig2o1 VP W W1 W2 Wald We Wi Wi1 Wio WY
tempname mh SST1 SST2 V Y Yh Nn N kx DF kb SSEo llf Sig2n
...
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** OLS Heteroscedasticity Hall-Pagan Test}}"
di _dup(78) "{bf:{err:=}}"
