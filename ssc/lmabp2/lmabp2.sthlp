{smcl}
{hline}
{cmd:help: {helpb lmabp2}}{space 50} {cmd:dialog:} {bf:{dialog lmabp2}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmabp2: 2SLS-IV Autocorrelation Box-Pierce Test at Higher Order AR(p)}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmabp2##01:Syntax}{p_end}
{p 5}{helpb lmabp2##02:Description}{p_end}
{p 5}{helpb lmabp2##03:Model}{p_end}
{p 5}{helpb lmabp2##04:GMM Options}{p_end}
{p 5}{helpb lmabp2##05:Other Options}{p_end}
{p 5}{helpb lmabp2##06:Saved Results}{p_end}
{p 5}{helpb lmabp2##07:References}{p_end}

{p 1}*** {helpb lmabp2##08:Examples}{p_end}

{p 5}{helpb lmabp2##09:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 2 4 2} 
{cmd:lmabp2} {depvar} {it:{help varlist:indepvars}} {cmd:({it:{help varlist:endog}} = {it:{help varlist:inst}})} {ifin} , {p_end} 
{p 6 6 2}
...
{pstd}
{cmd:lmabp2} computes 2SLS-IV Autocorrelation Box-Pierce Test for instrumental variables regression models, via 2sls, liml, melo, gmm, and kclass.{p_end}
...
{synopt:{bf:noconexog}}Exclude Constant Term from all Equations (both RHS and Instrumental Equations). Results of using {cmd:noconexog} option are identical to Stata {helpb ivregress}.
 The default of {cmd:lmabp2} is including Constant Term in both RHS and Instrumental Equations{p_end}

{marker 06}{bf:{err:{dlgtab:Saved Results}}}

{cmd:lmabp2} saves the following in {cmd:e()}:
...
{marker 08}{bf:{err:{dlgtab:Examples}}}
 ...
 {stata sysuse lmabp2.dta , clear}

 {stata db lmabp2}

 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls) lag(1)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls) lag(2)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls) lag(3)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(melo)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(liml)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(fuller) kf(0.5)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(kclass) kc(0.5)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(white)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(bart)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(dan)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(nwest)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(parzen)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(quad)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tent)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(trunc)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tukeym)}
 {stata lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tukeyn)}
{hline}

. clear all
. sysuse lmabp2.dta , clear
. lmabp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls) lag(3)
...
==============================================================================
* 2SLS-IV Autocorrelation Box-Pierce Test - Model= (2sls)
==============================================================================
 Ho: No Autocorrelation - Ha: Autocorrelation
------------------------------------------------------------------------------
- Rho Value for                        AR(1)= -0.0855
- Box-Pierce LM Test                   AR(1)=  0.1242  P-Value >Chi2(1) 0.7245
------------------------------------------------------------------------------
- Rho Value for                        AR(2)= -0.2334
- Box-Pierce LM Test                   AR(2)=  1.0504  P-Value >Chi2(2) 0.5914
------------------------------------------------------------------------------
- Rho Value for                        AR(3)=  0.1275
- Box-Pierce LM Test                   AR(3)=  1.3266  P-Value >Chi2(3) 0.7228
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMABP2 Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2014)}{p_end}
{p 1 10 1}{cmd:LMABP2: "Stata Module to Compute 2SLS-IV Autocorrelation Box-Pierce Test at Higher Order AR(p)"}{p_end}
