{smcl}
{hline}
{cmd:help: {helpb lmnwhite2}}{space 50} {cmd:dialog:} {bf:{dialog lmnwhite2}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmnwhite2: 2SLS-IV White IM Non Normality Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmnwhite2##01:Syntax}{p_end}
{p 5}{helpb lmnwhite2##02:Description}{p_end}
{p 5}{helpb lmnwhite2##03:Model}{p_end}
{p 5}{helpb lmnwhite2##04:GMM Options}{p_end}
{p 5}{helpb lmnwhite2##05:Other Options}{p_end}
{p 5}{helpb lmnwhite2##06:Saved Results}{p_end}
{p 5}{helpb lmnwhite2##07:References}{p_end}

{p 1}*** {helpb lmnwhite2##08:Examples}{p_end}

{p 5}{helpb lmnwhite2##09:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 2 4 2} 
{cmd:lmnwhite2} {depvar} {it:{help varlist:indepvars}} {cmd:({it:{help varlist:endog}} = {it:{help varlist:inst}})} {ifin} , {p_end} 
{p 6 6 2}
...
{pstd}
{cmd:lmnwhite2} computes 2SLS-IV White IM Non Normality Test for instrumental variables regression models, via 2sls, liml, melo, gmm, and kclass.{p_end}
...
{synopt:{bf:noconexog}}Exclude Constant Term from all Equations (both RHS and Instrumental Equations). Results of using {cmd:noconexog} option are identical to Stata {helpb ivregress}.
 The default of {cmd:lmnwhite2} is including Constant Term in both RHS and Instrumental Equations{p_end}

{marker 06}{bf:{err:{dlgtab:Saved Results}}}

{cmd:lmnwhite2} saves the following in {cmd:e()}:
...
{marker 08}{bf:{err:{dlgtab:Examples}}}
 ...
 {stata sysuse lmnwhite2.dta , clear}

 {stata db lmnwhite2}

 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(melo)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(liml)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(fuller) kf(0.5)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(kclass) kc(0.5)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(White)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(bart)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(dan)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(nwest)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(parzen)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(quad)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tent)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(trunc)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tukeym)}
 {stata lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tukeyn)}
{hline}

. clear all
. sysuse lmnwhite2.dta , clear
. lmnwhite2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls)
...
==============================================================================
*** 2SLS-IV Non Normality Tests - Model= (2sls)
==============================================================================
 Ho: Normality - Ha: Non Normality
------------------------------------------------------------------------------
*** Non Normality Tests:
- White IM Test                        =   3.6861     P-Value > Chi2(2) 0.1583
...
{bf:{err:{dlgtab:LMNWHITE2 Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2016)}{p_end}
{p 1 10 1}{cmd:LMNWHITE2: "Stata Module to Compute 2SLS-IV White IM Non Normality Test}{p_end}
