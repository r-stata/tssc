...
*! tweaked for 1 - 1/VIF   cfb  07mar2015
program define vif2, rclass sort
	version 6.0
	...
	quietly {
		...
		*/ "    Variable {c |}       VIF       1/VIF   1 - 1/VIF"
		noi di in smcl in gr "{hline 13}{c +}{hline 34}"
		local i 1
		local nv 0
		estimate hold `ehold'
