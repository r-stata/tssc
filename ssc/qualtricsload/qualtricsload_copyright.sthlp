...
{p2colset 1 27 29 2}{...}
{p2col:{bf:qualtricsload copyright}{hline 2}}qualtricsload copyright notification{p_end}
{p2colreset}{...}
...
{p 4 4 2}
qualtricload uses the following libraries, the Apache License, version 2.0: jackson-databind 
({browse "https://github.com/FasterXML/jackson":https://github.com/FasterXML/jackson}) and 
httpclient & httpcore from Apache HttpComponents Library ({browse "http://hc.apache.org/":http://hc.apache.org/})
{p_end}
