{smcl}
{hline}
{cmd:help: {helpb lmngr}}{space 55} {cmd:dialog:} {bf:{dialog lmngr}}
{hline}


{bf:{err:{dlgtab:Title}}}

{bf: lmngr: Geary Non Normality Lagrange Multiplier Runs Test}

{bf:{err:{dlgtab:Syntax}}}

{p 8 16 2}
{opt lmngr} {depvar} {indepvars} {ifin} {weight} , [ {opt nocons:tant} {opth vce(vcetype)} ]{p_end} 
...
{p 2 2 2} lmngr computes Geary Lagrange Multiplier non normality runs test for OLS residuals after {helpb regress} command.{p_end}
...
{pstd}
{cmd:lmngr} saves the following in {cmd:r()}:
...
{bf:{err:{dlgtab:lmngr Citation}}}

{phang}Shehata, Emad Abd Elmessih (2011){p_end}
{phang}{cmd: "lmngr: Stata Module to Compute Geary Non Normality Lagrange Multiplier Runs Test"}{p_end}

	{browse "http://ideas.repec.org/c/boc/bocode/s457349.html"}

	{browse "http://econpapers.repec.org/software/bocbocode/s457349.htm"}
