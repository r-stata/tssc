...
qui count if `DF1' > 0
local Rn=r(N)
local lmngr=(`Rn'-`EN')/`SN'
local p = chiprob(2, abs(`lmngr'))
di as txt "{bf:{err:======================================}}"
