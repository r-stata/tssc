...
program define lmhharv2 , eclass byable(onecall)
version 11.2
...
tempvar LnE2 LE XQ ht Hat Yhat1 Yho Yh_ML Ue_ML Wio Wi DFF DFF1 DFF2 xq LY Yh
...
tempname X X0 Vec J Ds SST1 SST2 Sig2o1 CovC SSE Sig2
tempname lf F K B Bx Zo V Nn kx kb DF N ky kyi kzi llf rhsendog Kz biv2 viv2 kmelo
...
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** 2SLS-IV Heteroscedasticity Harvey Test - Model= ({bf:{err:`model'}})}}"
di _dup(78) "{bf:{err:=}}"
