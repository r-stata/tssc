{smcl}
{hline}
{cmd:help: {helpb lmhharv2}}{space 50} {cmd:dialog:} {bf:{dialog lmhharv2}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmhharv2: 2SLS-IV Heteroscedasticity Harvey Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmhharv2##01:Syntax}{p_end}
{p 5}{helpb lmhharv2##02:Description}{p_end}
{p 5}{helpb lmhharv2##03:Model}{p_end}
{p 5}{helpb lmhharv2##04:GMM Options}{p_end}
{p 5}{helpb lmhharv2##05:Other Options}{p_end}
{p 5}{helpb lmhharv2##06:Saved Results}{p_end}
{p 5}{helpb lmhharv2##07:References}{p_end}

{p 1}*** {helpb lmhharv2##08:Examples}{p_end}

{p 5}{helpb lmhharv2##09:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 2 4 2} 
{cmd:lmhharv2} {depvar} {it:{help varlist:indepvars}} {cmd:({it:{help varlist:endog}} = {it:{help varlist:inst}})} {ifin} , {p_end} 
{p 6 6 2}
...
{pstd}
{cmd:lmhharv2} computes 2SLS-IV Heteroscedasticity Harvey Test for instrumental variables regression models, via 2sls, liml, melo, gmm, and kclass.{p_end}
...
{synopt:{bf:noconexog}}Exclude Constant Term from all Equations (both RHS and Instrumental Equations). Results of using {cmd:noconexog} option are identical to Stata {helpb ivregress}.
 The default of {cmd:lmhharv2} is including Constant Term in both RHS and Instrumental Equations{p_end}

{marker 06}{bf:{err:{dlgtab:Saved Results}}}

{cmd:lmhharv2} saves the following in {cmd:e()}:
...
{marker 08}{bf:{err:{dlgtab:Examples}}}
 ...
 {stata sysuse lmhharv2.dta , clear}

 {stata db lmhharv2}

 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(melo)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(liml)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(fuller) kf(0.5)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(kclass) kc(0.5)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(white)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(bart)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(dan)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(nwest)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(parzen)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(quad)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tent)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(trunc)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tukeym)}
 {stata lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tukeyn)}
{hline}

. clear all
. sysuse lmhharv2.dta , clear
. lmhharv2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls)
...
==============================================================================
*** 2SLS-IV Heteroscedasticity Harvey Test - Model= (2sls)
==============================================================================
 Ho: Homoscedasticity - Ha: Heteroscedasticity
------------------------------------------------------------------------------
- Harvey LM Test:       LogE2 = X      =   3.0695    P-Value > Chi2(2)  0.2155
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMHHARV2 Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2015)}{p_end}
{p 1 10 1}{cmd:LMHHARV2: "Stata Module to Compute 2SLS-IV Heteroscedasticity Harvey Test}{p_end}
