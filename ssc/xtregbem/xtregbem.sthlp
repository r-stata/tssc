{smcl}
{hline}
{cmd:help: {helpb xtregbem}}{space 50} {cmd:dialog:} {bf:{dialog xtregbem}}
{hline}
...
{marker 12}{bf:{err:{dlgtab:Examples}}}
  ...
  {stata xtregbem y x1 x2 , id(id) it(t) mfx(lin) predict(Yh) resid(Eu) diag lmh}

  {stata xtregbem y x1 x2 , id(id) it(t) mfx(log) predict(Yh) resid(Eu) diag lmh tolog}
...
---------------------------------------------------------------------------
- Akaike Information Criterion              (1974) AIC     =    203.1005
- Akaike Information Criterion              (1973) Log AIC =      5.3137
---------------------------------------------------------------------------
- Schwarz Criterion                         (1978) SC      =    228.0412
- Schwarz Criterion                         (1978) Log SC  =      5.4295
---------------------------------------------------------------------------
- Amemiya Prediction Criterion              (1969) FPE     =    233.6014
- Hannan-Quinn Criterion                    (1979) HQ      =    212.2246
- Rice Criterion                            (1984) Rice    =    204.7668
- Shibata Criterion                         (1981) Shibata =    201.6966
- Craven-Wahba Generalized Cross Validation (1979) GCV     =    203.8959
------------------------------------------------------------------------------
...
{p 1 10 1}{cmd:XTREGBEM: "Between-Effects Panel Data: Ridge and Weighted Regression"}{p_end}

	{browse "http://ideas.repec.org/c/boc/bocode/s457454.html"}

	{browse "http://econpapers.repec.org/software/bocbocode/s457454.htm"}
