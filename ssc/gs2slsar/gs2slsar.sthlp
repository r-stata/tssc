{smcl}
{hline}
{cmd:help: {helpb gs2slsar}}{space 50} {cmd:dialog:} {bf:{dialog gs2slsar}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:gs2slsar: Generalized Spatial Autoregressive Two Stage Least Squares (2SLS)}
{p 10}{bf:Cross Sections Regression}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb gs2slsar##01:Syntax}{p_end}
{p 5}{helpb gs2slsar##02:Description}{p_end}
{p 5}{helpb gs2slsar##03:Model Options}{p_end}
{p 5}{helpb gs2slsar##04:Options}{p_end}
{p 5}{helpb gs2slsar##05:Spatial Aautocorrelation Tests}{p_end}
{p 5}{helpb gs2slsar##06:Model Selection Diagnostic Criteria}{p_end}
{p 5}{helpb gs2slsar##07:Heteroscedasticity Tests}{p_end}
{p 5}{helpb gs2slsar##08:Non Normality Tests}{p_end}
{p 5}{helpb gs2slsar##09:Saved Results}{p_end}
{p 5}{helpb gs2slsar##10:References}{p_end}

{p 1}*** {helpb gs2slsar##11:Examples}{p_end}

{p 5}{helpb gs2slsar##12:Author}{p_end}

{p2colreset}{...}
{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 3 5 6}
{opt gs2slsar} {depvar} {indepvars} {weight} , {opt wmf:ile(weight_file)}{p_end} 
{p 3 5 6} 
{err: [} {opt m:odel(2sls|gmm|liml)} {opt lmsp:ac} {opt lmh:et} {opt lmn:orm} {opt diag} {opt test:s} {opt stand inv inv2} {opt ord:er(#)}{p_end} 
{p 5 5 6} 
{opt mfx(lin, log)} {opt aux(varlist)} {opt pred:ict(new_var)} {opt res:id(new_var)}{p_end} 
{p 5 5 6} 
...
{p 3 4 2} {cmd:gs2slsar} estimates Generalized Spatial Autoregressive Two Stage Least Squares [Kelejian-Prucha(1998)], for Cross Sections Regression Models.
Since no softwares available till now to estimate generalized spatial autoregressive 2SLS for cross section models, I designed {cmd:gs2slsar} as a modification of Kapoor-Kelejian-Prucha (1999),
...
{p 5 5 5}Buse(1973) R2 in {bf: model({err:{it:gs2slsar}})} may be negative, to avoid negative R2, you can increase number on instrumental variables by choosing order more than 1 {cmd:order(2, 3, 4)}{p_end}

{bf:{err:*** Important Notes:}}
{cmd:gs2slsar} generates some variables names with prefix:
...
{p 2 4 2 }{cmd:gs2slsar} saves the following results in {cmd:e()}:
...
{bf:Note 3:} You can use the dialog box for {dialog gs2slsar}.
{hline}

{stata clear all}

{stata sysuse gs2slsar.dta, clear}

{bf:* (1) Generalized Spatial Autoregressive 2SLS - AR(1) (gs2slsar)}
{stata gs2slsar y x1 x2 , wmfile(SPWcs) order(1) mfx(lin) test}

{stata gs2slsar y x1 x2    , wmfile(SPWcs) order(1) mfx(lin) test aux(x3)}
{stata gs2slsar y x1 x2 x3 , wmfile(SPWcs) order(1) mfx(lin) test}

* note the difference of x3 coef with and without aux option.

{stata gs2slsar y x1 x2 , wmfile(SPWcs) order(1) mfx(log) test tolog}

{stata gs2slsar y x1 x2 [weight=x1] , wmfile(SPWcs) order(1) mfx(lin) test}
{hline}

{bf:* (2) Generalized Spatial Autoregressive 2SLS - AR(2) (gs2slsar)}
{stata gs2slsar y x1 x2 , wmfile(SPWcs) order(2) mfx(lin) test}
{hline}

{bf:* (3) Generalized Spatial Autoregressive 2SLS - AR(3) (gs2slsar)}
{stata gs2slsar y x1 x2 , wmfile(SPWcs) order(3) mfx(lin) test}
{hline}

{bf:* (4) Generalized Spatial Autoregressive 2SLS - AR(4) (gs2slsar)}
{stata gs2slsar y x1 x2 , wmfile(SPWcs) order(4) mfx(lin) test}
{hline}

{bf:* (5) Generalized Spatial Autoregressive GMM - AR(1) (gs2slsar)}
{stata gs2slsar y x1 x2 , wmfile(SPWcs) order(1) mfx(lin) test model(gmm)}
{hline}

{bf:* (6) Generalized Spatial Autoregressive LIML - AR(1) (gs2slsar)}
{stata gs2slsar y x1 x2 , wmfile(SPWcs) order(1) mfx(lin) test model(liml)}
{hline}

{bf:{err:* Generalized Spatial Autoregressive 2SLS (GS2SLSAR)} (Cont.)}
 ...
 Results of {bf:({err:{it:gs2slsar}})} with order(2) is identical to:
 {browse "http://econweb.umd.edu/~prucha/STATPROG/2SLS/PROGRAM2.log"}

	{stata clear all}
	{stata sysuse gs2slsar1.dta , clear}
	{stata gs2slsar y x1 , wmfile(SPWcs1) order(2)}
{hline}
...
==============================================================================
==============================================================================
* Generalized Spatial Autoregressive Two Stage Least Squares (GS2SLSAR)
==============================================================================
  y = w1y_y + x1 + x2
------------------------------------------------------------------------------
  Sample Size       =          49
  Wald Test         =     64.5302   |   P-Value > Chi2(3)       =      0.0000
  F-Test            =     21.5101   |   P-Value > F(3 , 46)     =      0.0000
 (Buse 1973) R2     =      0.4421   |   Raw Moments R2          =      0.8986
 (Buse 1973) R2 Adj =      0.4178   |   Raw Moments R2 Adj      =      0.8941
  Root MSE (Sigma)  =     12.7668   |   Log Likelihood Function =   -192.7755
------------------------------------------------------------------------------
- R2h= 0.4666   R2h Adj= 0.4434  F-Test =   13.12 P-Value > F(3 , 46)  0.0000
- R2v= 0.6640   R2v Adj= 0.6494  F-Test =   29.64 P-Value > F(3 , 46)  0.0000
------------------------------------------------------------------------------
           y |      Coef.   Std. Err.      t    P>|t|     [95% Conf. Interval]
-------------+----------------------------------------------------------------
       w1y_y |  -.0507279   .0325268    -1.56   0.126    -.1162009    .0147452
          x1 |  -.3577038   .1161887    -3.08   0.004    -.5915795   -.1238282
          x2 |   -1.65663   .3191003    -5.19   0.000    -2.298946   -1.014315
       _cons |   82.73615   9.880248     8.37   0.000     62.84825    102.6241
------------------------------------------------------------------------------
  Rho Value  = -0.0507       F Test =     2.432    P-Value > F(1, 46)   0.1257
------------------------------------------------------------------------------
...
- GLOBAL Moran MI            =   0.2132     P-Value > Z( 2.741)   0.0061
- GLOBAL Geary GC            =   0.6493     P-Value > Z(-2.849)   0.0044
- GLOBAL Getis-Ords GO       =  -1.0268     P-Value > Z(-1.022)   0.3069
------------------------------------------------------------------------------
- Moran MI Error Test        =   0.9040     P-Value > Z(10.833)   0.3660
------------------------------------------------------------------------------
- LM Error (Burridge)        =   4.1860     P-Value > Chi2(1)     0.0408
- LM Error (Robust)          =   0.5352     P-Value > Chi2(1)     0.4644
------------------------------------------------------------------------------
  Ho: Spatial Lagged Dependent Variable has No Spatial AutoCorrelation
  Ha: Spatial Lagged Dependent Variable has    Spatial AutoCorrelation

- LM Lag (Anselin)           =   3.7857     P-Value > Chi2(1)     0.0517
- LM Lag (Robust)            =   0.1349     P-Value > Chi2(1)     0.7134
------------------------------------------------------------------------------
  Ho: No General Spatial AutoCorrelation
  Ha:    General Spatial AutoCorrelation

- LM SAC (LMErr+LMLag_R)     =   4.3209     P-Value > Chi2(2)     0.1153
- LM SAC (LMLag+LMErr_R)     =   4.3209     P-Value > Chi2(2)     0.1153
------------------------------------------------------------------------------

==============================================================================
* Model Selection Diagnostic Criteria
==============================================================================
- Log Likelihood Function       LLF               =  -192.7755
- Akaike Final Prediction Error AIC               =   393.5510
- Schwarz Criterion             SC                =   401.1183
- Akaike Information Criterion  ln AIC            =     5.1938
- Schwarz Criterion             ln SC             =     5.3482
- Amemiya Prediction Criterion  FPE               =   176.2954
- Hannan-Quinn Criterion        HQ                =   191.0181
- Rice Criterion                Rice              =   182.8670
- Shibata Criterion             Shibata           =   177.9925
- Craven-Wahba Generalized Cross Validation-GCV   =   181.4221
------------------------------------------------------------------------------
...
==============================================================================
 Ho: Homoscedasticity - Ha: Heteroscedasticity
------------------------------------------------------------------------------
- Hall-Pagan LM Test:      E2 = Yh     =   0.3087    P-Value > Chi2(1)  0.5785
- Hall-Pagan LM Test:      E2 = Yh2    =   0.3867    P-Value > Chi2(1)  0.5340
- Hall-Pagan LM Test:      E2 = LYh2   =   0.0002    P-Value > Chi2(1)  0.9895
------------------------------------------------------------------------------
- Harvey LM Test:       LogE2 = X      =   9.4468    P-Value > Chi2(2)  0.0089
- Wald LM Test:         LogE2 = X      =  23.3090    P-Value > Chi2(1)  0.0000
- Glejser LM Test:        |E| = X      =   7.4778    P-Value > Chi2(2)  0.0238
------------------------------------------------------------------------------
- Machado-Santos-Silva Test: Ev=Yh Yh2 =   0.8115    P-Value > Chi2(2)  0.6665
- Machado-Santos-Silva Test: Ev=X      =   7.4295    P-Value > Chi2(3)  0.0594
------------------------------------------------------------------------------
- White Test -Koenker(R2): E2 = X      =   7.5813    P-Value > Chi2(3)  0.0555
- White Test -B-P-G (SSR): E2 = X      =   8.3450    P-Value > Chi2(3)  0.0394
------------------------------------------------------------------------------
- White Test -Koenker(R2): E2 = X X2   =   9.3282    P-Value > Chi2(6)  0.1559
- White Test -B-P-G (SSR): E2 = X X2   =  10.2679    P-Value > Chi2(6)  0.1138
------------------------------------------------------------------------------
- White Test -Koenker(R2): E2 = X X2 XX=  22.5613    P-Value > Chi2(9)  0.0073
- White Test -B-P-G (SSR): E2 = X X2 XX=  24.8339    P-Value > Chi2(9)  0.0032
------------------------------------------------------------------------------
- Cook-Weisberg LM Test  E2/Sig2 = Yh  =   0.3398    P-Value > Chi2(1)  0.5599
- Cook-Weisberg LM Test  E2/Sig2 = X   =   8.3450    P-Value > Chi2(3)  0.0394
------------------------------------------------------------------------------
*** Single Variable Tests (E2/Sig2):
- Cook-Weisberg LM Test: w1y_y             =   1.1518 P-Value > Chi2(1) 0.2832
- Cook-Weisberg LM Test: x1                =   1.9612 P-Value > Chi2(1) 0.1614
- Cook-Weisberg LM Test: x2                =   1.8730 P-Value > Chi2(1) 0.1711
------------------------------------------------------------------------------
*** Single Variable Tests:
- King LM Test: w1y_y                      =   0.9640 P-Value > Chi2(1) 0.3262
- King LM Test: x1                         =   0.9705 P-Value > Chi2(1) 0.3246
- King LM Test: x2                         =   2.0373 P-Value > Chi2(1) 0.1535
...
------------------------------------------------------------------------------
*** Non Normality Tests:
- Jarque-Bera LM Test                  =   0.8712     P-Value > Chi2(2) 0.6469
- White IM Test                        =   3.9414     P-Value > Chi2(2) 0.1394
- Doornik-Hansen LM Test               =   1.6641     P-Value > Chi2(2) 0.4352
- Geary LM Test                        =  -3.0301     P-Value > Chi2(2) 0.2198
- Anderson-Darling Z Test              =   0.2011     P > Z( 1.216)     0.8881
- D'Agostino-Pearson LM Test           =   1.5506     P-Value > Chi2(2) 0.4606
------------------------------------------------------------------------------
*** Skewness Tests:
- Srivastava LM Skewness Test          =   0.7342     P-Value > Chi2(1) 0.3915
- Small LM Skewness Test               =   0.8897     P-Value > Chi2(1) 0.3456
- Skewness Z Test                      =  -0.9432     P-Value > Chi2(1) 0.3456
------------------------------------------------------------------------------
*** Kurtosis Tests:
- Srivastava  Z Kurtosis Test          =   0.3701     P-Value > Z(0,1)  0.7113
- Small LM Kurtosis Test               =   0.6609     P-Value > Chi2(1) 0.4162
- Kurtosis Z Test                      =   0.8130     P-Value > Chi2(1) 0.4162
------------------------------------------------------------------------------
    Skewness Coefficient = -0.2998     - Standard Deviation =  0.3398
    Kurtosis Coefficient =  3.2590     - Standard Deviation =  0.6681
------------------------------------------------------------------------------
    Runs Test: (15) Runs -  (25) Positives - (24) Negatives
    Standard Deviation Runs Sig(k) =  3.4619 , Mean Runs E(k) = 25.4898
    95% Conf. Interval [E(k)+/- 1.96* Sig(k)] = (18.7045 , 32.2751 )
------------------------------------------------------------------------------

* Linear: Marginal Effect - Elasticity - (Model= 2sls) *

+-----------------------------------------------------------------------------+
|     Variable | Marginal_Effect(B) |     Elasticity(Es) |               Mean |
|--------------+--------------------+--------------------+--------------------|
|        w1y_y |            -0.0507 |            -0.2461 |           170.4034 |
|           x1 |            -0.3577 |            -0.3914 |            38.4362 |
|           x2 |            -1.6566 |            -0.6779 |            14.3749 |
+-----------------------------------------------------------------------------+
...
{bf:{err:{dlgtab:GS2SLSAR Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih (2012)}{p_end}
{p 1 10 1}{cmd:GS2SLSAR: "Generalized Spatial Autoregressive Two Stage Least Squares (2SLS) Cross Sections Regression"}{p_end}

	{browse "http://ideas.repec.org/c/boc/bocode/S457474.html"}

	{browse "http://econpapers.repec.org/software/bocbocode/S457474.htm"}
