{smcl}
{hline}
{cmd:help: {helpb lmabpg}}{space 50} {cmd:dialog:} {bf:{dialog lmabpg}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmabpg: OLS Autocorrelation Breusch-Pagan-Godfrey Test at Higher Order AR(p)}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmabpg##01:Syntax}{p_end}
{p 5}{helpb lmabpg##02:Description}{p_end}
{p 5}{helpb lmabpg##03:Options}{p_end}
{p 5}{helpb lmabpg##04:Saved Results}{p_end}
{p 5}{helpb lmabpg##05:References}{p_end}

{p 1}*** {helpb lmabpg##06:Examples}{p_end}

{p 5}{helpb lmabpg##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{cmd:lmabpg} {depvar} {it:{help varlist:indepvars}} {ifin} , {err: [} {opt nocons:tant} {opt lag:s(#)} {opt coll} {err:]}{p_end}

{marker 02}{bf:{err:{dlgtab:Description}}}

{pstd}
{cmd:lmabpg} computes OLS Autocorrelation Breusch-Pagan-Godfrey Test at Higher Order AR(p)
...
{cmd:lmabpg} saves the following in {cmd:e()}:
...
{marker 06}{bf:{err:{dlgtab:Examples}}}
 ...
 {stata clear all}
 {stata sysuse lmabpg.dta , clear}

 {stata db lmabpg}

 {stata lmabpg y x1 x2 , lags(1)}
 {stata lmabpg y x1 x2 , lags(2)}
 {stata lmabpg y x1 x2 , lags(3)}
{hline}

. clear all
. sysuse lmabpg.dta , clear
. lmabpg y x1 x2 , lags(3)
...
------------------------------------------------------------------------------
 ...
 R2  (R-Squared)    =      0.9513   |   Raw Moments R2          =      0.9986
 R2a (Adjusted R2)  =      0.9443   |   Raw Moments R2 Adj      =      0.9984
...
------------------------------------------------------------------------------
==============================================================================
*** OLS Autocorrelation Breusch-Pagan-Godfrey Test Test
==============================================================================
 Ho: No Autocorrelation - Ha: Autocorrelation
------------------------------------------------------------------------------
- Rho Value for Order(1)               AR(1)= -0.1455
- Breusch-Pagan-Godfrey LM Test        AR(1)=  0.7014  P-Value >Chi2(1) 0.4023
------------------------------------------------------------------------------
- Rho Value for Order(2)               AR(2)= -0.2231
- Breusch-Pagan-Godfrey LM Test        AR(2)=  1.2257  P-Value >Chi2(2) 0.5418
------------------------------------------------------------------------------
- Rho Value for Order(3)               AR(3)=  0.1871
- Breusch-Pagan-Godfrey LM Test        AR(3)=  0.9975  P-Value >Chi2(3) 0.8019
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMABPG Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2015)}{p_end}
{p 1 10 1}{cmd:LMABPG: "Stata Module to Compute OLS Autocorrelation Breusch-Pagan-Godfrey Test"}{p_end}
