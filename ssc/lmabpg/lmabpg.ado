...
tempname b B Beta Bx Cov D E E1 F h Hat HT IPhi J K L M OM P Phi Pm Q 
...
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** OLS Autocorrelation Breusch-Pagan-Godfrey Test Test}}"
di _dup(78) "{bf:{err:=}}"
