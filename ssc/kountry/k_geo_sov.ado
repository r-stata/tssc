/***** Generate a separate region for former Soviet republics including Russia*****/
// based on k_geo_men.ado

program k_geo_sov
version 8.2

generate str11 GEO = ""
replace GEO = "Post Soviet" if NAMES_STD == "Armenia" | ///
...
replace GEO = "Asia" if NAMES_STD == "China" | ///
   NAMES_STD == "Hong Kong" | ///
   NAMES_STD == "Macao" | ///
...
replace GEO = "Europe" if NAMES_STD == "Bulgaria" | ///
