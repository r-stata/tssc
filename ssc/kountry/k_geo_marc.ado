/***** MARC (Library of Congress) regions *****/

program k_geo_marc
version 8.2

generate str15 GEO = ""
replace GEO = "Africa" if NAMES_STD == "Algeria" | ///
   NAMES_STD == "Angola" | ///
   NAMES_STD == "Benin " | ///
   NAMES_STD == "Botswana" | ///
...
replace GEO = "Atlantic Ocean" if NAMES_STD == "Bermuda" | ///
   NAMES_STD == "Cape Verde" | ///
   NAMES_STD == "Faeroe Islands" | ///
   NAMES_STD == "Falkland Islands" | ///
   NAMES_STD == "Saint Helena"

replace GEO = "Australasia" if NAMES_STD == "Australia" | ///
...
replace GEO = "Indian Ocean" if NAMES_STD == "Christmas Islands" | ///
   NAMES_STD == "Cocos Islands" | ///
   NAMES_STD == "Comoros" | ///
   NAMES_STD == "Maldives" | ///
   NAMES_STD == "Mauritius" | ///
   NAMES_STD == "Mayotte" | ///
...
replace GEO = "North America" if NAMES_STD == "Canada" | ///
   NAMES_STD == "Greenland" | ///
   NAMES_STD == "Mexico" | ///
   NAMES_STD == "Saint Pierre and Miquelon" | ///
   NAMES_STD == "United States"

replace GEO = "Pacific Ocean" if NAMES_STD == "American Samoa" | ///
...
replace GEO = "West Indies" if NAMES_STD == "Anguilla" | ///
