{smcl}
{hline}
{cmd:help: {helpb lmabpgxt}}{space 50} {cmd:dialog:} {bf:{dialog lmabpgxt}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmabpgxt: Panel Data Autocorrelation Breusch-Pagan-Godfrey Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmabpgxt##01:Syntax}{p_end}
{p 5}{helpb lmabpgxt##02:Description}{p_end}
{p 5}{helpb lmabpgxt##03:Options}{p_end}
{p 5}{helpb lmabpgxt##04:Saved Results}{p_end}
{p 5}{helpb lmabpgxt##05:References}{p_end}

{p 1}*** {helpb lmabpgxt##06:Examples}{p_end}

{p 5}{helpb lmabpgxt##07:Authors}{p_end}

{p2colreset}{...}
{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{opt lmabpgxt} {depvar} {indepvars} {ifin} {weight} , {bf:{err:id(var)}} {bf:{err:it(var)}} {err: [} {opt dlag(#)} {opt nocons:tant} {opt coll} {err:]}{p_end}

{p2colreset}{...}
{marker 02}{bf:{err:{dlgtab:Description}}}

{p 2 2 2} {cmd:lmabpgxt} computes Panel Data Autocorrelation Breusch-Pagan-Godfrey Test.
...
{p 2 4 2 }{cmd:lmabpgxt} saves the following results in {cmd:e()}:

{err:*** Panel Serial Autocorrelation Tests:}
{col 4}{cmd:e(rho)}{col 20}Panel Rho Value
{col 4}{cmd:e(lmabpgk1)}{col 20}Breusch-Pagan-Godfrey Z Test (keep 1 obs)
{col 4}{cmd:e(lmabpgk1p)}{col 20}Breusch-Pagan-Godfrey Z Test (keep 1 obs) P-Value
{col 4}{cmd:e(lmabpgk)}{col 20}Breusch-Pagan-Godfrey Z Test (keep 1 cs obs)
{col 4}{cmd:e(lmabpgkp)}{col 20}Breusch-Pagan-Godfrey Z Test (keep 1 cs obs) P-Value
...
{marker 06}{bf:{err:{dlgtab:Examples}}}
  ...
  {stata sysuse lmabpgxt.dta, clear}

  {stata db lmabpgxt}

  {stata lmabpgxt y x1 x2 , id(id) it(t)}
 

. clear all

. sysuse lmabpgxt.dta, clear

. lmabpgxt y x1 x2 , id(id) it(t)
...
==============================================================================
*** Panel Autocorrelation Breusch-Pagan-Godfrey Test
==============================================================================
  Ho: No AR(1) Panel AutoCorrelation - Ha: AR(1) Panel AutoCorrelation

- Panel Rho Value                         =   0.4233
- Breusch-Pagan-Godfrey Z (keep 1 nt obs) =   2.8756  P-Value > Z(0,1)  0.0040
- Breusch-Pagan-Godfrey Z (drop 1 cs obs) =   2.9873  P-Value > Z(0,1)  0.0028
- Breusch-Pagan-Godfrey Z (keep 1 cs obs) =   3.1346  P-Value > Z(0,1)  0.0017
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMABPGXT Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2014)}{p_end}
{p 1 10 1}{cmd:LMABPGXT: "Stata Module to Compute Panel Data Autocorrelation Breusch-Pagan-Godfrey Test"}{p_end}
