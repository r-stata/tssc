{smcl}
{hline}
{cmd:help: {helpb lmadwnl}}{space 50} {cmd:dialog:} {bf:{dialog lmadwnl}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmadwnl: NLS Autocorrelation Durbin-Watson Test at Higher Order AR(p)}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmadwnl##01:Syntax}{p_end}
{p 5}{helpb lmadwnl##02:Options}{p_end}
{p 5}{helpb lmadwnl##03:Description}{p_end}
{p 5}{helpb lmadwnl##04:Saved Results}{p_end}
{p 5}{helpb lmadwnl##05:References}{p_end}

{p 1}*** {helpb lmadwnl##06:Examples}{p_end}

{p 5}{helpb lmadwnl##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 3 5 6}
{cmd:lmadwnl} {depvar} {ifin} {weight} , {opt fun(expression)} {opt lag:s(#)}{p_end} 
{p 5 5 6}
...
{pstd}
{cmd:lmadwnl} computes NLS Autocorrelation Durbin-Watson Test at Higher Order AR(p).
...
{cmd:lmadwnl} saves the following in {cmd:e()}:
...
{stata sysuse lmadwnl.dta , clear}

{stata gen ly=ln(y)}

{stata "lmadwnl ly , fun({B0}+{B1}*k+{B2}*l)"}

{stata "lmadwnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5) lag(4)"}
{hline}

. clear all
. sysuse lmadwnl.dta , clear
. gen ly=ln(y)
. lmadwnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5) lag(4)
...
==============================================================================
*** NLS Autocorrelation Durbin-Watson Test
==============================================================================
 Ho: No Autocorrelation - Ha: Autocorrelation
------------------------------------------------------------------------------
- Rho Value for Order(1)               AR(1)=  0.0271
- Durbin-Watson Test                   AR(1)=  1.8773  df: (4 , 30)
------------------------------------------------------------------------------
- Rho Value for Order(2)               AR(2)=  0.0098
- Durbin-Watson Test                   AR(2)=  1.7860  df: (4 , 30)
------------------------------------------------------------------------------
- Rho Value for Order(3)               AR(3)= -0.0134
- Durbin-Watson Test                   AR(3)=  1.7747  df: (4 , 30)
------------------------------------------------------------------------------
- Rho Value for Order(4)               AR(4)= -0.3725
- Durbin-Watson Test                   AR(4)=  2.4202  df: (4 , 30)
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMADWNL Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2012)}{p_end}
{p 1 10 1}{cmd:LMADWNL: "NLS Autocorrelation Durbin-Watson Test at Higher Order AR(p)"}{p_end}
