...
tempvar DW E EE Eo Time TimeN U Ue_ML U2 E LE LEo
tempname E E1 EE1 Eo N kx DF SSEo Rho lmadw SSE
 local wgt
 if "`weight'`exp'" != "" {
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** NLS Autocorrelation Durbin-Watson Test}}"
di _dup(78) "{bf:{err:=}}"
