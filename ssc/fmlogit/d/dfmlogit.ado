...
program define dfmlogit, rclas sortpreserve
	if c(stata_version) >= 11 {
        version 11
		di as err "dfmlogit only exists for older versions of Stata"
        di as err "use margins instead"
		exit 198
    }
    else {
        version 8.2
