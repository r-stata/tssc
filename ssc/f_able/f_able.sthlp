{smcl}
{* *! version 1.0 Fernando Rios-Avila March 2020}{...}
{cmd:help f_able}
{hline}
...
{p 8 17 2}
{cmd:f_able} {cmd:,} {cmdab:nl:var(varlist)} 
...
{p2coldent : {opt nlvar(varlist)}} is used to indicate all variables in the model that are constructed variables. 
...
{pstd} And just for completness we estimate the effects across various points of the age {p_end}
...
{p 7 14 2}
Help:  {helpb margins}, {helpb predict}, {helpb _coef_table}  {p_end}
