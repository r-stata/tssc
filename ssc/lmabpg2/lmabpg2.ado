...
program define lmabpg2 , eclass byable(onecall)
version 11.2
...
tempvar Yt e LDE DF1 Eo Lambda0 Yh2 LYh2 E3 E4 Yhr YYm Yh
...
tempname Wio Wi Ew OM Omega hjm Wald We v ECov kyi kzi
...
tempname X X0 Vec J SST1 SST2 Sig2o1 CovC SSE Sig2 F K B Bx Zo V
...
qui regress `E' `LEo`i'' `xvar' if `touse'
scalar `lmabpg'`i'=sqrt(e(N)*e(r2))
 }
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** 2SLS-IV Autocorrelation Breusch-Pagan-Godfrey Test - Model= ({bf:{err:`model'}})}}"
di _dup(78) "{bf:{err:=}}"
