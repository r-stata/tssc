{smcl}
{hline}
{cmd:help: {helpb lmharch}}{space 50} {cmd:dialog:} {bf:{dialog lmharch}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmharch: OLS Heteroscedasticity Engle (ARCH) Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmharch##01:Syntax}{p_end}
{p 5}{helpb lmharch##02:Description}{p_end}
{p 5}{helpb lmharch##03:Options}{p_end}
{p 5}{helpb lmharch##04:Saved Results}{p_end}
{p 5}{helpb lmharch##05:References}{p_end}

{p 1}*** {helpb lmharch##06:Examples}{p_end}

{p 5}{helpb lmharch##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{cmd:lmharch} {depvar} {it:{help varlist:indepvars}} {ifin} , {err: [} {opt nocons:tant} {opt lag:s(#)} {opt coll} {err:]}{p_end}

{marker 02}{bf:{err:{dlgtab:Description}}}

{pstd}
{cmd:lmharch} computes OLS Engle LM AutoRegressive Conditional Heteroscedasticity (ARCH) Test
...
{pstd}
{cmd:lmharch} saves the following in {cmd:e()}:
...
{marker 06}{bf:{err:{dlgtab:Examples}}}
 ...
 {stata sysuse lmharch.dta , clear}

 {stata db lmharch}

 {stata lmharch y x1 x2 , lags(4)}
{hline}
...
------------------------------------------------------------------------------
==============================================================================
*** OLS Heteroscedasticity Engle (ARCH) Test
==============================================================================
 Ho: Homoscedasticity - Ha: Heteroscedasticity
------------------------------------------------------------------------------
- Engle LM ARCH Test AR(1) E2=E2_1-E2_1=   1.4900    P-Value > Chi2(1)  0.2222
- Engle LM ARCH Test AR(2) E2=E2_1-E2_2=   1.7011    P-Value > Chi2(2)  0.4272
- Engle LM ARCH Test AR(3) E2=E2_1-E2_3=   3.1166    P-Value > Chi2(3)  0.3740
- Engle LM ARCH Test AR(4) E2=E2_1-E2_4=   4.1508    P-Value > Chi2(4)  0.3860
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMHARCH Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2012)}{p_end}
{p 1 10 1}{cmd:LMHARCH: "OLS Heteroscedasticity Engle (ARCH) Test"}{p_end}
