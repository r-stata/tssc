...
tempvar E EE Eo DE SRho Time TimeN U Ue_ML U2 LE SBB
tempname E E1 EE1 Eo N SSEo Rho BB SSE SBBs lmalb
 local wgt
 if "`weight'`exp'" != "" {
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** NLS Autocorrelation Ljung-Box Test}}"
di _dup(78) "{bf:{err:=}}"
