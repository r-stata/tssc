...
capture mata: mata drop cquadbasic()
capture program drop cquadbasic

// --------------------------------------------------------------------
program cquadbasic, eclass 

  version 11

  display ""
  display "Fit (simplified) quadratic exponential model by Conditional Maximum Likelihood"
