...
capture program drop setpoisson_me
program define setpoisson_me, eclass
version 11
...
if ("`cmode'" != "") {
 ...
 mata: MagEff_setpcmode("e(exedv)"," e(exsv)","e(exordv)","`touse'", "`cvar'",`atcmode')
}
else{
 mata: MagEff_setpoisson("e(exedv)"," e(exsv)","e(exordv)","`touse'", `option_1',`qxb')
}
drop one
