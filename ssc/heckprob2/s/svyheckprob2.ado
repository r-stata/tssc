...
*! version 1.0.9  10may2004
program define svyheckprob2, sortpreserve
	version 8

	if replay() {
		if "`e(cmd)'" != "svyheckprob2" {
			error 301
		}
...
/* Fit full model */
	...
	*/ crittype("log pseudo-likelihood")				/*
	*/
