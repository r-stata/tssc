...
{viewerjumpto "Syntax" "opchar_gs##syntax"}{...}
{viewerjumpto "Description" "opchar_gs##description"}{...}
{viewerjumpto "Options" "opchar_gs##options"}{...}
{viewerjumpto "Remarks" "opchar_gs##remarks"}{...}
{viewerjumpto "Examples" "opchar_gs##examples"}{...}
{title:Title}
{phang}
{bf:opchar_gs} {hline 2} Determine the operating characteristics of group sequential single-arm trial designs for a single binary endpoint
...
For each value of pi in the supplied numlist pi, opchar_gs evaluates the power,
ESS, and other key characteristics, of each of the supplied designs.
...
{phang}
{stata opchar_gs, n(15, 10) a(1, 5) r(., 6)}
