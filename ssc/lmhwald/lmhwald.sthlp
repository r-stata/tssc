{smcl}
{hline}
{cmd:help: {helpb lmhwald}}{space 50} {cmd:dialog:} {bf:{dialog lmhwald}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmhwald: OLS Heteroscedasticity Wald Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmhwald##01:Syntax}{p_end}
{p 5}{helpb lmhwald##02:Description}{p_end}
{p 5}{helpb lmhwald##03:Options}{p_end}
{p 5}{helpb lmhwald##04:Heteroscedasticity Tests}{p_end}
{p 5}{helpb lmhwald##05:Saved Results}{p_end}
{p 5}{helpb lmhwald##06:References}{p_end}

{p 1}*** {helpb lmhwald##07:Examples}{p_end}

{p 5}{helpb lmhwald##08:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{cmd:lmhwald} {depvar} {it:{help varlist:indepvars}} {ifin} , {err: [} {opt nocons:tant} {opt coll} {err:]}{p_end}

{marker 02}{bf:{err:{dlgtab:Description}}}

{pstd}
{cmd:lmhwald} computes OLS Heteroscedasticity Wald Test
...
{p2colreset}{...}
{marker 04}{bf:{err:{dlgtab:Heteroscedasticity Test}}}
...
{pstd}
{cmd:lmhwald} saves the following in {cmd:e()}:
...
{marker 07}{bf:{err:{dlgtab:Examples}}}
 ...
 {stata clear all}
 {stata sysuse lmhwald.dta , clear}

 {stata db lmhwald}

 {stata lmhwald y x1 x2}
{hline}

. clear all
. sysuse lmhwald.dta , clear
. lmhwald y x1 x2
...
==============================================================================
*** OLS Heteroscedasticity Wald Test
==============================================================================
 Ho: Homoscedasticity - Ha: Heteroscedasticity
------------------------------------------------------------------------------
- Wald LM Test:         LogE2 = X      =   8.4400    P-Value > Chi2(1)  0.0037
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMHWALD Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2013)}{p_end}
{p 1 10 1}{cmd:LMHWALD: "OLS Heteroscedasticity Wald Test"}{p_end}
