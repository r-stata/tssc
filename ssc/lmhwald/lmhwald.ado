...
tempvar DE DF1 E E2 Wi ht LDE LE LEo LnE2 SSE Time wald weit
tempvar Wio WS X0 Yb Yh Yh2 Yhb Yho YY YYm YYv Yh_ML Ue_ML TimeN
tempname b B Beta Bx Cov D E E1 F Hat HT IPhi J K P Phi Pm Q X X0
tempname Sig2 Sig2n Sig2o Sig2o1 VP W Wald We Wi Wi1 Wio
tempname SST1 SST2 V Y Yh Nn N kx DF kb SSEo llf
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** OLS Heteroscedasticity Wald Test}}"
di _dup(78) "{bf:{err:=}}"
