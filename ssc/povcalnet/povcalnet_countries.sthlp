...
{viewerjumpto "povcalnet main help file" "povcalnet"}{...}
{viewerjumpto "Regions" "povcalnet_countries##regions"}{...}
{viewerjumpto "Countries" "povcalnet_countries##countries"}{...}
{title:PovcalNet - Regions and Countries codes}
{phang}

{marker regions}{...}
{p 40 20 2}(Get Back to  {it:{help povcalnet:main help file}}){p_end}
{title:Region Codes}
...
{p 40 20 2}(Go up to {it:{help povcalnet_countries:top}}){p_end}
