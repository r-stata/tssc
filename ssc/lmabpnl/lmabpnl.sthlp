{smcl}
{hline}
{cmd:help: {helpb lmabpnl}}{space 50} {cmd:dialog:} {bf:{dialog lmabpnl}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmabpnl: NLS Autocorrelation Box-Pierce Test at Higher Order AR(p)}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmabpnl##01:Syntax}{p_end}
{p 5}{helpb lmabpnl##02:Options}{p_end}
{p 5}{helpb lmabpnl##03:Description}{p_end}
{p 5}{helpb lmabpnl##04:Saved Results}{p_end}
{p 5}{helpb lmabpnl##05:References}{p_end}

{p 1}*** {helpb lmabpnl##06:Examples}{p_end}

{p 5}{helpb lmabpnl##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 3 5 6}
{cmd:lmabpnl} {depvar} {ifin} {weight} , {opt fun(expression)} {opt lag:s(#)}{p_end} 
{p 5 5 6}
...
{pstd}
{cmd:lmabpnl} computes NLS Autocorrelation Box-Pierce Test at Higher Order AR(p).
...
{cmd:lmabpnl} saves the following in {cmd:e()}:
...
{stata sysuse lmabpnl.dta , clear}

{stata gen ly=ln(y)}

{stata "lmabpnl ly , fun({B0}+{B1}*k+{B2}*l)"}

{stata "lmabpnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5) lag(4)"}
{hline}

. clear all
. sysuse lmabpnl.dta , clear
. gen ly=ln(y)
. lmabpnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5) lag(4)
...
==============================================================================
*** NLS Autocorrelation Box-Pierce Test
==============================================================================
 Ho: No Autocorrelation - Ha: Autocorrelation
------------------------------------------------------------------------------
- Rho Value for Order(1)               AR(1)=  0.0271
- Box-Pierce LM Test                   AR(1)=  0.0220  P-Value >Chi2(1) 0.8820
------------------------------------------------------------------------------
- Rho Value for Order(2)               AR(2)=  0.0098
- Box-Pierce LM Test                   AR(2)=  0.0249  P-Value >Chi2(2) 0.9876
------------------------------------------------------------------------------
- Rho Value for Order(3)               AR(3)= -0.0134
- Box-Pierce LM Test                   AR(3)=  0.0303  P-Value >Chi2(3) 0.9986
------------------------------------------------------------------------------
- Rho Value for Order(4)               AR(4)= -0.3725
- Box-Pierce LM Test                   AR(4)=  4.1924  P-Value >Chi2(4) 0.3806
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMABPNL Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2012)}{p_end}
{p 1 10 1}{cmd:LMABPNL: "NLS Autocorrelation Box-Pierce Test at Higher Order AR(p)"}{p_end}
