...
program define lmnwhitext, eclass 
version 11.0
...
tempvar D DE DF1 DW E dcs TimeN EE idv itv LE P Q Sig2 SSE
tempvar SST Time wald weit Wi Wio WS X X0 Bo
tempvar Xb XB Xo XQ Yb Yh Yh2 Yhb Yho Yt YY YYm YYv Yh_ML Ue_ML Z
tempvar D DE DF DF1 E E2 LDE LE P Q Sig2 SSE
tempvar Xb XB Yb Yh Yh2 Yhb Yho Yt YY Z A B b Beta Bx Cov D den DF Dim Dx E E1 eVec 
tempname IPhi J K kb kx llf M M1 M2 N NC NT P Phi Pm Q Sig2 Sig21 Sig2o
tempname SSE SSEo SST1 SST2 Sw Ue Ue_ML Vec Vs W W1 W2 Wald waldm We Wi 
...
tempname Hat Eb Sk Ku M2 M3 M4 K2 K3 K4 Ss Kk GK R2W S1 S2 S3 S4
qui tsset `Time'
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** Panel Data Non Normality White Test}}"
di _dup(78) "{bf:{err:=}}"
