{smcl}
{hline}
{cmd:help: {helpb lmhglnl}}{space 50} {cmd:dialog:} {bf:{dialog lmhglnl}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmhglnl: NLS Heteroscedasticity Glejser Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmhglnl##01:Syntax}{p_end}
{p 5}{helpb lmhglnl##02:Options}{p_end}
{p 5}{helpb lmhglnl##03:Description}{p_end}
{p 5}{helpb lmhglnl##04:Saved Results}{p_end}
{p 5}{helpb lmhglnl##05:References}{p_end}

{p 1}*** {helpb lmhglnl##06:Examples}{p_end}

{p 5}{helpb lmhglnl##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 3 5 6}
{cmd:lmhglnl} {depvar} {ifin} {weight} , {opt fun(expression)}{p_end} 
{p 5 5 6}
...
{pstd}
{cmd:lmhglnl} computes Non Linear Least Squares Heteroscedasticity Glejser Test.
...
{pstd}
{cmd:lmhglnl} saves the following in {cmd:e()}:
...
{stata sysuse lmhglnl.dta , clear}

{stata gen ly=ln(y)}

{stata "lmhglnl ly , fun({B0}+{B1}*k+{B2}*l)"}

{stata "lmhglnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5)"}
{hline}

. clear all
. sysuse lmhglnl.dta , clear
. gen ly=ln(y)
. lmhglnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5)
...
==============================================================================
*** NLS Heteroscedasticity Glejser Test
==============================================================================
 Ho: Homoscedasticity - Ha: Heteroscedasticity
------------------------------------------------------------------------------
- Glejser LM Test:        |E| = X      =   3.6604    P-Value > Chi2(2)  0.1604
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMHGLNL Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2015)}{p_end}
{p 1 10 1}{cmd:LMHGLNL: "Stata Module to Compute NLS Heteroscedasticity Glejser Test"}
