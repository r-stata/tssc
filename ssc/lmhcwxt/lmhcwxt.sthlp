{smcl}
{hline}
{cmd:help: {helpb lmhcwxt}}{space 50} {cmd:dialog:} {bf:{dialog lmhcwxt}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmhcwxt: Panel Data Heteroscedasticity Cook-Weisberg Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmhcwxt##01:Syntax}{p_end}
{p 5}{helpb lmhcwxt##02:Options}{p_end}
{p 5}{helpb lmhcwxt##03:Description}{p_end}
{p 5}{helpb lmhcwxt##04:Saved Results}{p_end}
{p 5}{helpb lmhcwxt##05:References}{p_end}

{p 1}*** {helpb lmhcwxt##06:Examples}{p_end}

{p 5}{helpb lmhcwxt##07:Authors}{p_end}

{p2colreset}{...}
{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{opt lmhcwxt} {depvar} {indepvars} {ifin} , {bf:{err:id(var)}} {bf:{err:it(var)}} {err: [} {opt nocons:tant} {opt cross} {opt coll} {err:]}{p_end}
...
{p 2 2 2} {cmd:lmhcwxt} computes Panel Data Heteroscedasticity Cook-Weisberg Test.
...
{p 2 4 2 }{cmd:lmhcwxt} saves the following results in {cmd:e()}:
...
{marker 06}{bf:{err:{dlgtab:Examples}}}
  ...
  {stata sysuse lmhcwxt.dta, clear}

  {stata db lmhcwxt}

  {stata lmhcwxt y x1 x2 , id(id) it(t)}
{hline}

. clear all
. sysuse lmhcwxt.dta, clear
. lmhcwxt y x1 x2 , id(id) it(t)
...
- Cook-Weisberg LM Test: E2/S2n = Yh    =   0.9872   P-Value > Chi2(1)  0.3204
- Cook-Weisberg LM Test: E2/S2n = X     =  10.0129   P-Value > Chi2(2)  0.0067
------------------------------------------------------------------------------
*** Single Variable Tests (E2/Sig2):
- Cook-Weisberg LM Test: x1                =   1.2953 P-Value > Chi2(1) 0.2551
- Cook-Weisberg LM Test: x2                =   3.9532 P-Value > Chi2(1) 0.0468
------------------------------------------------------------------------------
*** Single Variable Tests:
- King LM Test: x1                         =   0.2187 P-Value > Chi2(1) 0.6400
- King LM Test: x2                         =   4.2370 P-Value > Chi2(1) 0.0396
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMHCWXT Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2015)}{p_end}
{p 1 10 1}{cmd:LMHCWXT: "Stata Module to Compute Panel Data Heteroscedasticity Cook-Weisberg Test"}{p_end}
