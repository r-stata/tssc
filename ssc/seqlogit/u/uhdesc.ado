...
*! 1.1.15 MLB 27Mar2012
*! 1.1.13 MLB 06Sep2010
*! 1.1.11 MLB 07May2010
*! 1.1.8  MLB 08Apr2010
*! 1.1.5  MLB 18Jan2010

program define uhdesc, rclass
	syntax ,                         ///
	[                                ///        
	at(string)                       ///
	overat(string)                   ///
	...
	if "`e(cmd)'" != "seqlogit" {
		di as err "uhdesc can only be used after seqlogit
		exit 198
	}
	if "`e(sigma)'" == "" {
		di as err "uhdesc can only be used after seqlogit when the sigma() option is specified"
		exit 198
	}
	if "`overat'" != "" {
