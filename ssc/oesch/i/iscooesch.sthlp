...
{p 4 4 2}
This command converts 4 digit ISCO-08 {it:(International Classification of Occupations)} codes into the class scheme proposed by Oesch (2006).
...
{p 4 8 2}
{cmd:isco} specifies the variable to be recoded.
