{smcl}
{hline}
{cmd:help: {helpb lmadwxt}}{space 50} {cmd:dialog:} {bf:{dialog lmadwxt}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmadwxt: Panel Data Autocorrelation Durbin-Watson Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmadwxt##01:Syntax}{p_end}
{p 5}{helpb lmadwxt##02:Description}{p_end}
{p 5}{helpb lmadwxt##03:Options}{p_end}
{p 5}{helpb lmadwxt##04:Saved Results}{p_end}
{p 5}{helpb lmadwxt##05:References}{p_end}

{p 1}*** {helpb lmadwxt##06:Examples}{p_end}

{p 5}{helpb lmadwxt##07:Authors}{p_end}

{p2colreset}{...}
{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{opt lmadwxt} {depvar} {indepvars} {ifin} {weight} , {bf:{err:id(var)}} {bf:{err:it(var)}} {err: [} {opt nocons:tant} {opt coll} {err:]}{p_end}

{p2colreset}{...}
{marker 02}{bf:{err:{dlgtab:Description}}}

{p 2 2 2} {cmd:lmadwxt} computes Panel Data Autocorrelation Durbin-Watson Test.
...
{p 2 4 2 }{cmd:lmadwxt} saves the following results in {cmd:e()}:
...
{marker 06}{bf:{err:{dlgtab:Examples}}}
  ...
  {stata sysuse lmadwxt.dta, clear}

  {stata db lmadwxt}

  {stata lmadwxt y x1 x2 , id(id) it(t)}
 
 clear all
. sysuse lmadwxt.dta, clear
. lmadwxt y x1 x2 , id(id) it(t)
...
==============================================================================
*** Panel Data Autocorrelation Durbin-Watson Test
==============================================================================
  Ho: No AR(1) Panel AutoCorrelation - Ha: AR(1) Panel AutoCorrelation

- Panel Rho Value                 =   0.4233
- Durbin-Watson Test              =   1.0458     df: (3 , 49)
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMADWXT Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2015)}{p_end}
{p 1 10 1}{cmd:LMADWXT: "Stata Module to Compute Panel Data Autocorrelation Durbin-Watson Test"}{p_end}
