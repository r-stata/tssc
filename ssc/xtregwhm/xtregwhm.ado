...
program define xtregwhm, eclass 
version 11.0
...
tempname D den DF dfab Dim DVE DVNE Dx E E1 EE1 Eg Eo eVec CovC 
tempname Ew F f1 f13 f13d gam gam2 Go GoRY IDRmk In IPhi J K kb 
tempname kbm Ko Koi Kr kx L lf llf Ls M Sig2n Om Om1 Om2 Omm Omm1 Omm2
tempname N NC NE Nn NT Omega P Phi Pm Q Qr Xx Y Yh Yh_ML YYm YYv Z Z0 Z1 Zo Zr Zz
...
di 
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:* Wallace-Hussain Random-Effects Panel Data: Ridge and Weighted Regression}}"
di _dup(78) "{bf:{err:=}}"
