*! version 1.0 February 20, 2007 @ 10:09:28
*! Marks sequences that contain a specific sequence pattern
	
program _gsqmarkpattern
version 9
	...
	syntax varname [if] [in] [, Pattern(string) gapinclude SUBSEQuence(string) ] 
