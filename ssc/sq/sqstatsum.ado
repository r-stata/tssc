*! version 1.3 Oktober 11, 2011 @ 10:12:45 UK
...
program define sqstatsum, rclass
version 9
	syntax [varlist(default=none)] [if] [in]  /// 
	  [, NOt(varlist) exclude0 Listwise * ]
	...
	quietly by `_dta[SQiis]': keep if _n==1
