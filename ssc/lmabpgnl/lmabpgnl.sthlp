{smcl}
{hline}
{cmd:help: {helpb lmabpgnl}}{space 50} {cmd:dialog:} {bf:{dialog lmabpgnl}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmabpgnl: NLS Autocorrelation Breusch-Pagan-Godfrey Test at Higher Order AR(p)}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmabpgnl##01:Syntax}{p_end}
{p 5}{helpb lmabpgnl##02:Options}{p_end}
{p 5}{helpb lmabpgnl##03:Description}{p_end}
{p 5}{helpb lmabpgnl##04:Saved Results}{p_end}
{p 5}{helpb lmabpgnl##05:References}{p_end}

{p 1}*** {helpb lmabpgnl##06:Examples}{p_end}

{p 5}{helpb lmabpgnl##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 3 5 6}
{cmd:lmabpgnl} {depvar} {ifin} {weight} , {opt fun(expression)} {opt lag:s(#)}{p_end} 
{p 5 5 6}
...
{pstd}
{cmd:lmabpgnl} computes NLS Autocorrelation Breusch-Pagan-Godfrey Test at Higher Order AR(p).
...
{cmd:lmabpgnl} saves the following in {cmd:e()}:
...
{stata sysuse lmabpgnl.dta , clear}

{stata gen ly=ln(y)}

{stata "lmabpgnl ly , fun({B0}+{B1}*k+{B2}*l)"}

{stata "lmabpgnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5) lag(4)"}
{hline}

. clear all
. sysuse lmabpgnl.dta , clear
. gen ly=ln(y)
. lmabpgnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5) lag(4)
...
-------------+----------------------------------------------------------------
          ...
          /D |   .3366735   .1361128     2.47   0.020     .0568895    .6164575
------------------------------------------------------------------------------
  Parameter B taken as constant term in model & ANOVA table

==============================================================================
*** NLS Autocorrelation Breusch-Pagan-Godfrey Test
==============================================================================
 Ho: No Autocorrelation - Ha: Autocorrelation
------------------------------------------------------------------------------
- Rho Value for Order(1)               AR(1)=  0.0271
- Breusch-Pagan-Godfrey LM Test        AR(1)=  0.4650  P-Value >Chi2(1) 0.4953
------------------------------------------------------------------------------
- Rho Value for Order(2)               AR(2)=  0.0098
- Breusch-Pagan-Godfrey LM Test        AR(2)=  0.4815  P-Value >Chi2(2) 0.7860
------------------------------------------------------------------------------
- Rho Value for Order(3)               AR(3)= -0.0134
- Breusch-Pagan-Godfrey LM Test        AR(3)=  0.4654  P-Value >Chi2(3) 0.9264
------------------------------------------------------------------------------
- Rho Value for Order(4)               AR(4)= -0.3725
- Breusch-Pagan-Godfrey LM Test        AR(4)=  2.2040  P-Value >Chi2(4) 0.6983
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMABPGNL Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2016)}{p_end}
{p 1 10 1}{cmd:LMABPGNL: "Stata Module to Compute NLS Autocorrelation Breusch-Pagan-Godfrey Test at Higher Order AR(p)"}{p_end}
