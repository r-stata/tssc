#delim ;
prog def sccenslope, rclass byable(onecall) sortpreserve;
version 16.0;
/*
 Use censlope
...
*
 Call censlope.
 THIS PART OF THE PROGRAM IS SPECIFIC TO sccenslope
...
`bybyvars' censlope `nyvar' `nscen' [`weight'=`nweight'] , cluster(`cluster') cfweight(`ncfweight') funtype(vonmises) `options';
return add;
