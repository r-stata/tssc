{smcl}
{hline}
{cmd:help: {helpb lmhgl}}{space 55} {cmd:dialog:} {bf:{dialog lmhgl}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf: lmhgl: OLS Glejser Lagrange Multiplier Heteroscedasticity Test}

{bf:{err:{dlgtab:Syntax}}}

{p 10 16 2}
{opt lmhgl} {depvar} {indepvars} {ifin} {weight} , [ {opt nocons:tant} {opth vce(vcetype)} ]{p_end} 
...
{p 2 2 2}{cmd:lmhgl} computes Glejser Lagrange Multiplier Heteroscedasticity Test for OLS residuals after {helpb regress} command.{p_end} 

{bf:{err:{dlgtab:Saved Results}}}

{cmd:lmhgl} saves the following in {cmd:r()}:

{col 4}{cmd:r(lmh)}{col 20}Glejser IM Test
{col 4}{cmd:r(lmhp)}{col 20}Glejser IM Test P-Value
...
==============================================================================
 Ho: No Heteroscedasticity - Ha: Heteroscedasticity
    ...
    Glejser LM Test           =    3.46075
    Degrees of Freedom        =        2.0
    P-Value > Chi2(2)         =    0.17722
...
{bf:{err:{dlgtab:lmhgl Citation}}}

{phang}Shehata, Emad Abd Elmessih (2012){p_end}
{phang}{cmd: LMHGL: "Stata Module to Compute Glejser Lagrange Multiplier OLS Heteroscedasticity Test"}{p_end}
