{smcl}
{hline}
{cmd:help: {helpb lmhhp2}}{space 50} {cmd:dialog:} {bf:{dialog lmhhp2}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmhhp2: 2SLS-IV Hall-Pagan LM Heteroscedasticity Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmhhp2##01:Syntax}{p_end}
{p 5}{helpb lmhhp2##02:Description}{p_end}
{p 5}{helpb lmhhp2##03:Model}{p_end}
{p 5}{helpb lmhhp2##04:GMM Options}{p_end}
{p 5}{helpb lmhhp2##05:Other Options}{p_end}
{p 5}{helpb lmhhp2##06:Saved Results}{p_end}
{p 5}{helpb lmhhp2##07:References}{p_end}

{p 1}*** {helpb lmhhp2##08:Examples}{p_end}

{p 5}{helpb lmhhp2##09:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 2 4 2} 
{cmd:lmhhp2} {depvar} {it:{help varlist:indepvars}} {cmd:({it:{help varlist:endog}} = {it:{help varlist:inst}})} {ifin} , {p_end} 
{p 6 6 2}
...
{pstd}
{cmd:lmhhp2} computes 2SLS-IV Hall-Pagan LM Heteroscedasticity Test for instrumental variables regression models, via 2sls, liml, melo, gmm, and kclass.{p_end}
...
{synopt:{bf:noconexog}}Exclude Constant Term from all Equations (both RHS and Instrumental Equations). Results of using {cmd:noconexog} option are identical to Stata {helpb ivregress}.
 The default of {cmd:lmhhp2} is including Constant Term in both RHS and Instrumental Equations{p_end}

{marker 06}{bf:{err:{dlgtab:Saved Results}}}

{cmd:lmhhp2} saves the following in {cmd:e()}:
...
{marker 08}{bf:{err:{dlgtab:Examples}}}
 ...
 {stata sysuse lmhhp2.dta , clear}

 {stata db lmhhp2}

 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(melo)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(liml)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(fuller) kf(0.5)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(kclass) kc(0.5)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(white)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(bart)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(dan)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(nwest)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(parzen)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(quad)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tent)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(trunc)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tukeym)}
 {stata lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(gmm) hetcov(tukeyn)}
{hline}

. clear all
. sysuse lmhhp2.dta , clear
. lmhhp2 y1 x1 x2 (y2 = x1 x2 x3 x4) , model(2sls)
...
==============================================================================
* 2SLS-IV Heteroscedasticity Tests - Model= (2sls)
==============================================================================
 Ho: Homoscedasticity - Ha: Heteroscedasticity
------------------------------------------------------------------------------
- Hall-Pagan LM Test:      E2 = Yh     =   1.3713    P-Value > Chi2(1)  0.2416
- Hall-Pagan LM Test:      E2 = Yh2    =   1.3887    P-Value > Chi2(1)  0.2386
- Hall-Pagan LM Test:      E2 = LYh2   =   1.3329    P-Value > Chi2(1)  0.2483
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMHHP2 Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2014)}{p_end}
{p 1 10 1}{cmd:LMHHP2: "Stata Module to Compute 2SLS-IV Hall-Pagan LM Heteroscedasticity Test"}{p_end}
