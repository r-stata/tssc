{smcl}
{hline}
{cmd:help: {helpb sptobitmstardhxt}}{space 50} {cmd:dialog:} {bf:{dialog sptobitmstardhxt}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:sptobitmstardhxt: Tobit (m-STAR) Multiparametric Spatio Temporal AutoRegressive Regression}
{p 9 1 1}{bf:(Spatial Durbin Multiplicative Heteroscedasticity Panel Models)}{p_end}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb sptobitmstardhxt##01:Syntax}{p_end}
{p 5}{helpb sptobitmstardhxt##02:Description}{p_end}
{p 5}{helpb sptobitmstardhxt##03:Options}{p_end}
{p 5}{helpb sptobitmstardhxt##04:Spatial Panel Aautocorrelation Tests}{p_end}
{p 5}{helpb sptobitmstardhxt##05:Model Selection Diagnostic Criteria}{p_end}
{p 5}{helpb sptobitmstardhxt##06:Heteroscedasticity Tests}{p_end}
{p 5}{helpb sptobitmstardhxt##07:Non Normality Tests}{p_end}
{p 5}{helpb sptobitmstardhxt##08:Saved Results}{p_end}
{p 5}{helpb sptobitmstardhxt##09:References}{p_end}

{p 1}*** {helpb sptobitmstardhxt##10:Examples}{p_end}

{p 5}{helpb sptobitmstardhxt##11:Authors}{p_end}

{p2colreset}{...}
{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{opt sptobitmstardhxt} {depvar} {indepvars} {weight} , {bf:{err:nc(#)}} {opt wmf:ile(weight_file)} {opt ll(#)}{p_end} 
{p 3 5 6} 
{err: [} {opt lmsp:ac} {opt lmh:et} {opt lmn:orm} {opt diag} {opt test:s} {opt nocons:tant} {opt coll zero tolog nolog robust}{p_end} 
{p 5 5 6} 
{opt nw:mat(#)} {opt mhet(varlist)} {opt aux(varlist)} {opt stand inv inv2} {opt mfx(lin, log)}{p_end} 
{p 5 5 6} 
...
{p 2 2 2} {cmd:sptobitmstardhxt} estimates Tobit Spatial econometric regression (mSTAR) "Multiparametric Spatio Temporal AutoRegressive Regression" for Spatial Durbin Multiplicative Heteroscedasticity Panel Models.{p_end}

 {cmd:sptobitmstardhxt} can estimate the following models:
   1- Heteroscedastic Regression Models in disturbance term.
   2- Non Normal Regression Models in disturbance term.

{p 2 4 2}{cmd:sptobitmstardhxt} can generate:{p_end}
...
{p 2 4 2} {cmd:sptobitmstardhxt} predicted values are obtained from conditional expectation expression.{p_end}
...
{cmd:sptobitmstardhxt} generates some variables names with prefix:
...
{col 20}{cmd:sptobitmstardhxt} will convert automatically spatial cross section weight matrix
...
{p 2 4 2 }Depending on the model estimated, {cmd:sptobitmstardhxt} saves the following results in {cmd:e()}:
...
{bf:Note 3:} You can use the dialog box for {dialog sptobitmstardhxt}.
{bf:Note 4:} xtset is included automatically in {cmd:sptobitmstardhxt} models.

{hline}

  {stata clear all}

  {stata sysuse sptobitmstardhxt.dta, clear}

  {stata db sptobitmstardhxt}
...
{bf:* (1) mSTAR Model}
{stata sptobitmstardhxt ys x1 x2 , nc(7) wmfile(SPWmxt1) nwmat(1) mfx(lin) mhet(x1) ll(0)}
{stata sptobitmstardhxt ys x1 x2 , nc(7) wmfile(SPWmxt2) nwmat(2) mfx(lin) mhet(x1) ll(0)}
{stata sptobitmstardhxt ys x1 x2 , nc(7) wmfile(SPWmxt3) nwmat(3) mfx(lin) mhet(x1) ll(0)}
{stata sptobitmstardhxt ys x1 x2 , nc(7) wmfile(SPWmxt4) nwmat(4) mfx(lin) mhet(x1) ll(0)}
{hline}

{bf:* (2) Weighted mSTAR}
{stata sptobitmstardhxt ys x1 x2  [weight = x1], nc(7) wmfile(SPWmxt1) nwmat(1) mfx(lin) mhet(x1) ll(0)}
{stata sptobitmstardhxt ys x1 x2 [aweight = x1], nc(7) wmfile(SPWmxt1) nwmat(1) mfx(lin) mhet(x1) ll(0)}
{hline}

. clear all
. sysuse sptobitmstardhxt.dta, clear
. sptobitmstardhxt ys x1 x2 , wmfile(SPWmxt1) nc(7) nwmat(1) mfx(lin) test mhet(x1 x2) ll(0)
...
------------------------------------------------------------------------------
  ...
  Wald Test         =     41.6664   |   P-Value > Chi2(4)       =      0.0000
  F-Test            =     10.4166   |   P-Value > F(4 , 38)     =      0.0000
 (Buse 1973) R2     =      0.4864   |   Raw Moments R2          =      0.8250
 (Buse 1973) R2 Adj =      0.3512   |   Raw Moments R2 Adj      =      0.7789
  Root MSE (Sigma)  =     16.9714   |   Log Likelihood Function =   -210.3971
------------------------------------------------------------------------------
- R2h= 0.2723   R2h Adj= 0.0808  F-Test =    4.12 P-Value > F(4 , 38)  0.0072
- R2v= 0.2455   R2v Adj= 0.0470  F-Test =    3.58 P-Value > F(4 , 38)  0.0142
------------------------------------------------------------------------------
- Sum of Rho's =   -0.1015966    Sum must be < 1 for Stability Condition
------------------------------------------------------------------------------
          ys |      Coef.   Std. Err.      z    P>|z|     [95% Conf. Interval]
-------------+----------------------------------------------------------------
ys           |
          x1 |  -.5134832   .0765692    -6.71   0.000    -.6635561   -.3634103
          x2 |   .3514245   .2490306     1.41   0.158    -.1366665    .8395155
      w1x_x1 |   -.196666   .0421527    -4.67   0.000    -.2792836   -.1140483
      w1x_x2 |   .8218716   .2050512     4.01   0.000     .4199787    1.223764
       _cons |   31.79836    8.89313     3.58   0.000     14.36814    49.22857
-------------+----------------------------------------------------------------
Hetero       |
          x1 |  -.0169218   .0083354    -2.03   0.042    -.0332589   -.0005847
          x2 |  -.1182842   .0360156    -3.28   0.001    -.1888735   -.0476949
-------------+----------------------------------------------------------------
        Rho1 |  -.1015966   .0373724    -2.72   0.007    -.1748451   -.0283481
       Sigma |   150.4108   80.04856     1.88   0.060    -6.481549    307.3031
------------------------------------------------------------------------------
 Wald Test [Rho1=0]:                 7.3902        P-Value > Chi2(1) 0.0066
...
==============================================================================
- Log Likelihood Function                   LLF            =   -210.3971
---------------------------------------------------------------------------
- Akaike Information Criterion              (1974) AIC     =    297.2382
- Akaike Information Criterion              (1973) Log AIC =      5.6945
---------------------------------------------------------------------------
- Schwarz Criterion                         (1978) SC      =    389.4728
- Schwarz Criterion                         (1978) Log SC  =      5.9648
---------------------------------------------------------------------------
- Amemiya Prediction Criterion              (1969) FPE     =    329.1736
- Hannan-Quinn Criterion                    (1979) HQ      =    329.3333
- Rice Criterion                            (1984) Rice    =    312.7149
- Shibata Criterion                         (1981) Shibata =    287.1872
- Craven-Wahba Generalized Cross Validation (1979) GCV     =    304.0284
------------------------------------------------------------------------------
...
- GLOBAL Moran MI            =  -0.0770     P-Value > Z(-0.517)   0.6054
- GLOBAL Geary GC            =   0.9785     P-Value > Z(-0.161)   0.8719
- GLOBAL Getis-Ords GO       =   0.2419     P-Value > Z(0.517)    0.6054
------------------------------------------------------------------------------
- Moran MI Error Test        =   0.1060     P-Value > Z(1.167)    0.9156
------------------------------------------------------------------------------
- LM Error (Burridge)        =   0.2743     P-Value > Chi2(1)     0.6005
- LM Error (Robust)          =   0.2930     P-Value > Chi2(1)     0.5883
------------------------------------------------------------------------------
...
- LM Lag (Anselin)           =   0.9596     P-Value > Chi2(1)     0.3273
- LM Lag (Robust)            =   0.9783     P-Value > Chi2(1)     0.3226
------------------------------------------------------------------------------
  Ho: No General Spatial AutoCorrelation
  Ha:    General Spatial AutoCorrelation

- LM SAC (LMErr+LMLag_R)     =   1.2526     P-Value > Chi2(2)     0.5346
- LM SAC (LMLag+LMErr_R)     =   1.2526     P-Value > Chi2(2)     0.5346
------------------------------------------------------------------------------
...
- Engle LM ARCH Test AR(1): E2 = E2_1   =   0.1196   P-Value > Chi2(1)  0.7295
------------------------------------------------------------------------------
- Hall-Pagan LM Test:   E2 = Yh         =   1.0492   P-Value > Chi2(1)  0.3057
- Hall-Pagan LM Test:   E2 = Yh2        =   1.7627   P-Value > Chi2(1)  0.1843
- Hall-Pagan LM Test:   E2 = LYh2       =   0.0221   P-Value > Chi2(1)  0.8819
------------------------------------------------------------------------------
- Harvey LM Test:    LogE2 = X          =   8.9609   P-Value > Chi2(2)  0.0113
- Wald Test:         LogE2 = X          =  22.1100   P-Value > Chi2(1)  0.0000
- Glejser LM Test:     |E| = X          =  12.1671   P-Value > Chi2(2)  0.0023
- Breusch-Godfrey Test:  E = E_1 X      =   7.4363   P-Value > Chi2(1)  0.0064
------------------------------------------------------------------------------
- Machado-Santos-Silva Test: Ev=Yh Yh2  =   2.5085   P-Value > Chi2(2)  0.2853
- Machado-Santos-Silva Test: Ev=X       =   7.2606   P-Value > Chi2(4)  0.1227
------------------------------------------------------------------------------
- White Test - Koenker(R2): E2 = X      =   7.5063   P-Value > Chi2(4)  0.1114
- White Test - B-P-G (SSR): E2 = X      =   8.8398   P-Value > Chi2(4)  0.0652
------------------------------------------------------------------------------
- White Test - Koenker(R2): E2 = X X2   =  11.6335   P-Value > Chi2(8)  0.1683
- White Test - B-P-G (SSR): E2 = X X2   =  13.7002   P-Value > Chi2(8)  0.0899
------------------------------------------------------------------------------
- White Test - Koenker(R2): E2 = X X2 XX=  19.2466   P-Value > Chi2(14) 0.1557
- White Test - B-P-G (SSR): E2 = X X2 XX=  22.6658   P-Value > Chi2(14) 0.0659
------------------------------------------------------------------------------
- Cook-Weisberg LM Test: E2/S2n = Yh    =   1.2355   P-Value > Chi2(1)  0.2663
- Cook-Weisberg LM Test: E2/S2n = X     =   8.8398   P-Value > Chi2(4)  0.0652
------------------------------------------------------------------------------
*** Single Variable Tests (E2/Sig2):
- Cook-Weisberg LM Test: x1                =   0.1979 P-Value > Chi2(1) 0.6564
- Cook-Weisberg LM Test: x2                =   2.4828 P-Value > Chi2(1) 0.1151
- Cook-Weisberg LM Test: w1x_x1            =   0.1053 P-Value > Chi2(1) 0.7456
- Cook-Weisberg LM Test: w1x_x2            =   1.3506 P-Value > Chi2(1) 0.2452
------------------------------------------------------------------------------
*** Single Variable Tests:
- King LM Test: x1                         =   0.1538 P-Value > Chi2(1) 0.6949
- King LM Test: x2                         =   2.3693 P-Value > Chi2(1) 0.1237
- King LM Test: w1x_x1                     =   0.0698 P-Value > Chi2(1) 0.7916
- King LM Test: w1x_x2                     =   0.7896 P-Value > Chi2(1) 0.3742
------------------------------------------------------------------------------
...
------------------------------------------------------------------------------
*** Non Normality Tests:
- Jarque-Bera LM Test                  =   4.4937     P-Value > Chi2(2) 0.1057
- White IM Test                        =   5.5915     P-Value > Chi2(2) 0.0611
- Doornik-Hansen LM Test               =   4.9109     P-Value > Chi2(2) 0.0858
- Geary LM Test                        =   0.0000     P-Value > Chi2(2) 1.0000
- Anderson-Darling Z Test              =   0.6015     P > Z( 1.183)     0.8817
- D'Agostino-Pearson LM Test           =   5.4475     P-Value > Chi2(2) 0.0656
------------------------------------------------------------------------------
*** Skewness Tests:
- Srivastava LM Skewness Test          =   4.2360     P-Value > Chi2(1) 0.0396
- Small LM Skewness Test               =   4.5613     P-Value > Chi2(1) 0.0327
- Skewness Z Test                      =  -2.1357     P-Value > Chi2(1) 0.0327
------------------------------------------------------------------------------
*** Kurtosis Tests:
- Srivastava  Z Kurtosis Test          =   0.5077     P-Value > Z(0,1)  0.6117
- Small LM Kurtosis Test               =   0.8862     P-Value > Chi2(1) 0.3465
- Kurtosis Z Test                      =   0.9414     P-Value > Chi2(1) 0.3465
------------------------------------------------------------------------------
    Skewness Coefficient = -0.7202     - Standard Deviation =  0.3398
    Kurtosis Coefficient =  3.3553     - Standard Deviation =  0.6681
------------------------------------------------------------------------------
    Runs Test: (25) Runs -  (28) Positives - (21) Negatives
...
|--------------+------------+------------+------------+------------+------------|
|ys            |            |            |            |            |            |
|           x1 |    -0.5135 |    -0.4988 |    -0.6711 |     0.1722 |    38.4362 |
|           x2 |     0.3514 |     0.3414 |     0.4593 |    -0.1179 |    14.3749 |
|       w1x_x1 |    -0.1967 |    -0.1911 |    -0.2570 |     0.0660 |   126.1844 |
|       w1x_x2 |     0.8219 |     0.7984 |     1.0741 |    -0.2756 |    45.6271 |
+-------------------------------------------------------------------------------+
...
|--------------+------------+------------+------------+------------+------------|
|           x1 |    -0.6804 |    -0.6610 |    -0.8892 |     0.2282 |    38.4362 |
|           x2 |     0.1742 |     0.1692 |     0.2276 |    -0.0584 |    14.3749 |
|       w1x_x1 |    -0.8555 |    -0.8311 |    -1.1181 |     0.2869 |   126.1844 |
|       w1x_x2 |     1.2928 |     1.2559 |     1.6895 |    -0.4336 |    45.6271 |
+-------------------------------------------------------------------------------+
...
{bf:{err:{dlgtab:SPTOBITMSTARDHXT Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2013)}{p_end}
{p 1 10 1}{cmd:SPTOBITMSTARDHXT: "Tobit (m-STAR) Spatial Multiparametric Spatio Temporal AutoRegressive Regression: Spatial Durbin Multiplicative Heteroscedasticity Panel Models"}{p_end}
