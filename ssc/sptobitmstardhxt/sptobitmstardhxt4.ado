program define sptobitmstardhxt4
version 11.0
args lf XB ZB Rho1 Rho2 Rho3 Rho4 Sigma
...
qui replace `lf' = log(1-`Ro1'-`Ro2'-`Ro3'-`Ro4') ///
 +`D0'*log(normal(-(`rYW1'+`rYW2'+`rYW3'+`rYW4'+`XB')/((`Sigma'*exp(`ZB'))))) ///
 -0.5*log(2*_pi)-0.5*log(((`Sigma'*exp(`ZB')))^2) ///
 -0.5*`D1'*($ML_y1-`rYW1'-`rYW2'-`rYW3'-`rYW4'-`XB')^2/((`Sigma'*exp(`ZB')))^2
end
