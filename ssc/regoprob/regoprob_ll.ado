...
program define regoprob_ll
	...
	* Calculate score vector ********************************************************** *
	...
	matrix vecaccum `g11' = `gradb2' $S_x if $ML_y1 == $dv_1
	matrix vecaccum `g21' = `gradb1' $S_x if $ML_y1 == $dv_2
	matrix `g1' = `g11' + `g21'
	matrix `g' = `g1'

	forval ind = 2/$S_Numeqs {
		local indd = `ind' + 1
		matrix vecaccum `g1`ind'' = `gradb2' $S_x if $ML_y1 == ${dv_`ind'}
		matrix vecaccum `g2`ind'' = `gradb1' $S_x if $ML_y1 == ${dv_`indd'}
