...
{cmdab:va:lueadded} {cmdab:l:evel(#)} poly(#) seed(#) {cmdab:fsres:idual(newname)} {cmdab:endo:genous(varlist)} {cmdab:over:identification} {cmdab:gmm} {it:{help prodest##optoptions:opt_options}} {it:{help prodest##wrdgoptions:WRDG_options}}]
...
{cmdab:va:lueadded} {cmdab:l:evel(#)} poly(#) seed(#) {cmdab:fsres:idual(newname)} {cmdab:endo:genous(varlist)} {cmdab:over:identification} {it:{help prodest##optoptions:opt_options}} {it:{help prodest##roboptions:ROB_options}}]
...
{cmdab:va:lueadded} {cmdab:l:evel(#)} poly(#) seed(#) {cmdab:fsres:idual(newname)} lags(#) {cmdab:endo:genous(varlist)} {cmdab:over:identification} {it:{help prodest##optoptions:opt_options}} {it:{help prodest##mroptions:Mr_options}}]
