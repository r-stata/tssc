...
{p 8 16 2}
{cmd:predict} [{newvar}] {ifin} [{cmd:,} {cmdab:resid:uals} {cmdab:exp:onential} {cmdab:par:ameters} {cmdab:omega}]
...
{marker examples}{...}
{title:Examples}
{tab}{cmd:. insheet using "https://raw.githubusercontent.com/GabrieleRovigatti/prodest/master/stata/data/prodest.csv", names clear", names clear}}
{phang2}{it:({stata "insheet using https://raw.githubusercontent.com/GabrieleRovigatti/prodest/master/stata/data/prodest.csv", names clear, names clear":load data})}
