{smcl}
{hline}
{cmd:help: {helpb lmaznl}}{space 50} {cmd:dialog:} {bf:{dialog lmaznl}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmaznl: NLS Autocorrelation Z Test at Higher Order AR(p)}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmaznl##01:Syntax}{p_end}
{p 5}{helpb lmaznl##02:Options}{p_end}
{p 5}{helpb lmaznl##03:Description}{p_end}
{p 5}{helpb lmaznl##04:Saved Results}{p_end}
{p 5}{helpb lmaznl##05:References}{p_end}

{p 1}*** {helpb lmaznl##06:Examples}{p_end}

{p 5}{helpb lmaznl##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 3 5 6}
{cmd:lmaznl} {depvar} {ifin} {weight} , {opt fun(expression)} {opt lag:s(#)}{p_end} 
{p 5 5 6}
...
{pstd}
{cmd:lmaznl} computes NLS Autocorrelation Z Test at Higher Order AR(p).
...
{cmd:lmaznl} saves the following in {cmd:e()}:
...
{stata sysuse lmaznl.dta , clear}

{stata gen ly=ln(y)}

{stata "lmaznl ly , fun({B0}+{B1}*k+{B2}*l)"}

{stata "lmaznl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5) lag(4)"}
{hline}

. clear all
. sysuse lmaznl.dta , clear
. gen ly=ln(y)
. lmaznl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5) lag(4)
...
==============================================================================
*** NLS Autocorrelation Z Test
==============================================================================
 Ho: No Autocorrelation - Ha: Autocorrelation
------------------------------------------------------------------------------
- Rho Value for Order(1)               AR(1)=  0.0271
- Z Test                               AR(1)=  0.1484  P-Value >Chi2(1) 0.7001
------------------------------------------------------------------------------
- Rho Value for Order(2)               AR(2)=  0.0098
- Z Test                               AR(2)=  0.0538  P-Value >Chi2(2) 0.9735
------------------------------------------------------------------------------
- Rho Value for Order(3)               AR(3)= -0.0134
- Z Test                               AR(3)= -0.0735  P-Value >Chi2(3) 0.9948
------------------------------------------------------------------------------
- Rho Value for Order(4)               AR(4)= -0.3725
- Z Test                               AR(4)= -2.0401  P-Value >Chi2(4) 0.7284
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMAZNL Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2015)}{p_end}
{p 1 10 1}{cmd:LMAZNL: "Stata Module to Compute NLS Autocorrelation Z Test at Higher Order AR(p)"}{p_end}
