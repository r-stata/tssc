{smcl}
{hline}
{cmd:help: {helpb lmavonnl}}{space 50} {cmd:dialog:} {bf:{dialog lmavonnl}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmavonnl: NLS Autocorrelation Von Neumann Ratio Test at Higher Order AR(p)}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmavonnl##01:Syntax}{p_end}
{p 5}{helpb lmavonnl##02:Options}{p_end}
{p 5}{helpb lmavonnl##03:Description}{p_end}
{p 5}{helpb lmavonnl##04:Saved Results}{p_end}
{p 5}{helpb lmavonnl##05:References}{p_end}

{p 1}*** {helpb lmavonnl##06:Examples}{p_end}

{p 5}{helpb lmavonnl##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 3 5 6}
{cmd:lmavonnl} {depvar} {ifin} {weight} , {opt fun(expression)} {opt lag:s(#)}{p_end} 
{p 5 5 6}
...
{pstd}
{cmd:lmavonnl} computes NLS Autocorrelation Von Neumann Ratio Test at Higher Order AR(p).
...
{cmd:lmavonnl} saves the following in {cmd:e()}:
...
{stata sysuse lmavonnl.dta , clear}

{stata gen ly=ln(y)}

{stata "lmavonnl ly , fun({B0}+{B1}*k+{B2}*l)"}

{stata "lmavonnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5) lag(4)"}
{hline}
...
==============================================================================
*** NLS Autocorrelation Von Neumann Ratio Test
==============================================================================
 Ho: No Autocorrelation - Ha: Autocorrelation
------------------------------------------------------------------------------
- Rho Value for Order(1)               AR(1)=  0.0271
- Von Neumann Ratio Test               AR(1)=  1.9420  df: (4 , 30)
------------------------------------------------------------------------------
- Rho Value for Order(2)               AR(2)=  0.0098
- Von Neumann Ratio Test               AR(2)=  1.8476  df: (4 , 30)
------------------------------------------------------------------------------
- Rho Value for Order(3)               AR(3)= -0.0134
- Von Neumann Ratio Test               AR(3)=  1.8359  df: (4 , 30)
------------------------------------------------------------------------------
- Rho Value for Order(4)               AR(4)= -0.3725
- Von Neumann Ratio Test               AR(4)=  2.5036  df: (4 , 30)
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMAVONNL Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2012)}{p_end}
{p 1 10 1}{cmd:LMAVONNL: "NLS Autocorrelation Von Neumann Ratio Test at Higher Order AR(p)"}{p_end}
