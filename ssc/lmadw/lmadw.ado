...
return scalar dw_`i'=`dw`i''
 }
di as txt "{bf:{err:================================================}}"
di as txt "{bf:{err:* Durbin-Watson Autocorrelation Test           *}}"
di as txt "{bf:{err:================================================}}"
...
di as txt "* Durbin-Watson Test" _col(30) "AR(" `i' ") = " %9.4f `dw`i'' _col(50) "df: ("  Kx  " , " N ")
di _dup(75) "-"
 }
 }
end
