...
tempvar D DE DF1 E TimeN EE ht idv itv LE LEo P Q Sig2 SSE SST WS Bo
tempvar Yb Yh Yh2 Yhb Yt YY YYm YYv Yh_ML Ue_ML Z D DE DF DF1 YY Z
tempvar E LDE LE LEo P Q SRho SSE Time U2 wald weit Wi Wio X X0 Yb Yh Yh2 Yhb Yt
tempname A B b Beta Bx Cov D den DF Dim Dx E E1 Eo N NC Nn NT P Phi
tempname Ew F In IPhi J K kb kx llf Pm Q Rho Sig2 Sig21 Sig2o Sig2o1
tempname SST1 SST2 Ue Ue_ML vh W W1 W2 Wald waldm We Wi SSE SSEo
tempname V Wi1 Wio WS X X0 Y Yh Yh_ML YYm YYv Z
qui xtset `id' `it'
...
local NC2=r(imax)
qui tsset `Time'
tempname Rho Rhosq Rw1 Rw2 lmabp lmabpp SSEu SSE SSE1
tempvar Ue_ML1
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** Panel Data Autocorrelation Box-Pierce Test}}"
di _dup(78) "{bf:{err:=}}"
...
di as txt "- Box-Pierce LM Test" _col(35) "=" as res %9.4f `lmabp' _col(50) as txt "P-Value > Chi2(1)" _col(70) as res %5.4f `lmabpp'
di _dup(78) "-"
