{smcl}
{hline}
{cmd:help: {helpb lmabpxt}}{space 50} {cmd:dialog:} {bf:{dialog lmabpxt}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmabpxt: Panel Data Autocorrelation Box-Pierce Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmabpxt##01:Syntax}{p_end}
{p 5}{helpb lmabpxt##02:Description}{p_end}
{p 5}{helpb lmabpxt##03:Options}{p_end}
{p 5}{helpb lmabpxt##04:Saved Results}{p_end}
{p 5}{helpb lmabpxt##05:References}{p_end}

{p 1}*** {helpb lmabpxt##06:Examples}{p_end}

{p 5}{helpb lmabpxt##07:Authors}{p_end}

{p2colreset}{...}
{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{opt lmabpxt} {depvar} {indepvars} {ifin} {weight} , {bf:{err:id(var)}} {bf:{err:it(var)}} {err: [} {opt nocons:tant} {opt coll} {err:]}{p_end}

{p2colreset}{...}
{marker 02}{bf:{err:{dlgtab:Description}}}

{p 2 2 2} {cmd:lmabpxt} computes Panel Data Autocorrelation Box-Pierce Test.
...
{p 2 4 2 }{cmd:lmabpxt} saves the following results in {cmd:e()}:
...
{marker 06}{bf:{err:{dlgtab:Examples}}}
  ...
  {stata sysuse lmabpxt.dta, clear}

  {stata db lmabpxt}

  {stata lmabpxt y x1 x2 , id(id) it(t)}
 
. clear all
. sysuse lmabpxt.dta, clear
. lmabpxt y x1 x2 , id(id) it(t)
...
==============================================================================
*** Panel Data Autocorrelation Box-Pierce Test
==============================================================================
  Ho: No AR(1) Panel AutoCorrelation - Ha: AR(1) Panel AutoCorrelation

- Panel Rho Value                 =   0.4233
- Box-Pierce LM Test              =   8.7784     P-Value > Chi2(1)   0.0030
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMABPXT Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2014)}{p_end}
{p 1 10 1}{cmd:LMABPXT: "Stata Module to Compute Panel Data Autocorrelation Box-Pierce Test"}{p_end}
