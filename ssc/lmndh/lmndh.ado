...
tempvar E E2 E3 E4 Ea EE Eo Hat ht LDE LE LEo lf SSE Time wald weit Wi
tempvar Wio WS X0 Yb Yh Yh2 Yhb Yho Yt YY YYm YYv Yh_ML Ue_ML TimeN
tempname b B b1 b2 Beta Bv Bv1 Bx Cov D DX E E1 Hat HT IPhi J K L M
tempname M1 M2 n OM P Phi Pm q Q q1 q2 S Wald We Wi Wi1 SSEo llf mh
tempname Sig2 Sig2o Sn Sw v2 SST1 SST2 V Wio X X0 Y Yh Nn N kx DF kb
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** OLS Non Normality Doornik-Hansen Test}}"
di _dup(78) "{bf:{err:=}}"
