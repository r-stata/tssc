{smcl}
{hline}
{cmd:help: {helpb lmndh}}{space 50} {cmd:dialog:} {bf:{dialog lmndh}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmndh: OLS Non Normality Doornik-Hansen Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmndh##01:Syntax}{p_end}
{p 5}{helpb lmndh##02:Description}{p_end}
{p 5}{helpb lmndh##03:Options}{p_end}
{p 5}{helpb lmndh##04:Saved Results}{p_end}
{p 5}{helpb lmndh##05:References}{p_end}

{p 1}*** {helpb lmndh##06:Examples}{p_end}

{p 5}{helpb lmndh##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{cmd:lmndh} {depvar} {it:{help varlist:indepvars}} {ifin} , {err: [} {opt nocons:tant} {opt coll} {err:]}{p_end}

{marker 02}{bf:{err:{dlgtab:Description}}}

{pstd}
{cmd:lmndh} computes OLS Non Normality Doornik-Hansen Test
...
{pstd}
{cmd:lmndh} saves the following in {cmd:e()}:
...
{p 4 8 2}Doornik, Jurgen A. & Hansen, Henrik (1994)
{cmd: "An Omnibus Test for Univariate and Multivariate Normality",}
{it:Working Paper, Nuffield College, University of Oxford}.

{p 4 8 2}Doornik, Jurgen A. & Hansen, Henrik (2008)
{cmd: "An Omnibus Test for Univariate and Multivariate Normality",}
...
==============================================================================
*** OLS Non Normality Doornik-Hansen Test
==============================================================================
 Ho: Normality - Ha: Non Normality
------------------------------------------------------------------------------
- Doornik-Hansen LM Test               =   0.2231     P-Value > Chi2(2) 0.8944
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMNDH Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2014)}{p_end}
{p 1 10 1}{cmd:LMNDH: "Stata Module to Compute OLS Non Normality Doornik-Hansen Test"}{p_end}
