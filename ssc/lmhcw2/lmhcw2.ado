...
program define lmhcw2 , eclass byable(onecall)
version 11.2
...
tempvar Yt e LDE DF1 Eo Lambda0 Yh2 LYh2 E3 E4 Yhr YYm DumE EDumE
tempvar LnE2 LE XQ ht Hat Yhat1 Yho Yh_ML Ue_ML Wio Wi
...
tempname Wio Wi Ew OM Omega hjm Wald We vy1 v kyi kzi F K B Bx Zo qhiv V
tempname Bv1 Bv lamp1 lamp2 lamp M W b1 v1 q lmhs b2 v2 Beta P Pm IPhi Phi J D
tempname Hat Sig2n Wi1 Z0 Z1 xq Eo E1 EE1 Sw Sn nw S11 S12 WY Xgw Eg Sig2
tempname DCor X X0 Vec Val J Ds Cr Dr LVal LVal1 SLv2 S rid sqN SST1 SST2
tempname Sig2o1 CovC RY RX VaL VaL1 VaLv1 VaL21 Go GoRY SSE Sig2 Q L Sig2o
tempname Nn kx kb DF N ky kyi kzi llf rhsendog Kz biv2 viv2 kmelo
tempname SSEo Sigo r2bu r2bu_a r2raw r2raw_a f fp wald waldp Qr SLS
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** 2SLS-IV Heteroscedasticity Cook-Weisberg Test - Model= ({bf:{err:`model'}})}}"
di _dup(78) "{bf:{err:=}}"
