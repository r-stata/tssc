{smcl}
{hline}
{cmd:help: {helpb lmharchxt}}{space 50} {cmd:dialog:} {bf:{dialog lmharchxt}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmharchxt: Panel Data Heteroscedasticity Engle (ARCH) Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmharchxt##01:Syntax}{p_end}
{p 5}{helpb lmharchxt##02:Options}{p_end}
{p 5}{helpb lmharchxt##03:Description}{p_end}
{p 5}{helpb lmharchxt##04:Saved Results}{p_end}
{p 5}{helpb lmharchxt##05:References}{p_end}

{p 1}*** {helpb lmharchxt##06:Examples}{p_end}

{p 5}{helpb lmharchxt##07:Authors}{p_end}

{p2colreset}{...}
{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{opt lmharchxt} {depvar} {indepvars} {ifin} , {bf:{err:id(var)}} {bf:{err:it(var)}} {err: [} {opt nocons:tant} {opt cross} {opt coll} {err:]}{p_end}
...
{p 2 2 2} {cmd:lmharchxt} computes Panel Data Heteroscedasticity Engle (ARCH) Test.
...
{p 2 4 2 }{cmd:lmharchxt} saves the following results in {cmd:e()}:

{err:*** Panel Data Heteroscedasticity Tests:}
...
{marker 06}{bf:{err:{dlgtab:Examples}}}
  ...
  {stata sysuse lmharchxt.dta, clear}

  {stata db lmharchxt}

  {stata lmharchxt y x1 x2 , id(id) it(t)}
{hline}

. clear all
. sysuse lmharchxt.dta, clear
. lmharchxt y x1 x2 , id(id) it(t)
...
==============================================================================
*** Panel Data Heteroscedasticity Engle (ARCH) Test
==============================================================================
  Ho: Panel Homoscedasticity - Ha: Panel Heteroscedasticity

- Engle LM ARCH Test AR(1): E2 = E2_1   =   0.4523   P-Value > Chi2(1)  0.5012
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMHARCHXT Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2015)}{p_end}
{p 1 10 1}{cmd:LMHARCHXT: "Stata Module to Compute Panel Data Heteroscedasticity Engle (ARCH) Test"}{p_end}
