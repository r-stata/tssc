...
{hline}
{cmd:help stjm11 postestimation}{right:also see: {helpb stjm11}, {helpb stjmgraph}}
{hline}

{title:Title}

{p2colset 5 30 35 2}{...}
{p2col :{hi:stjm11 postestimation} {hline 2}}Post-estimation tools for stjm11{p_end}
{p2colreset}{...}
...
{p2col :{helpb stjm11 postestimation##predict:predict}}predictions, residuals etc{p_end}
...
{phang}{stata "stjm11 long_response, panel(id) survmodel(weibull) gh(5) ffracpoly(1)":. stjm11 long_response, panel(id) survmodel(weibull) gh(5) ffracpoly(1)}{p_end}

{pstd}Predict the marginal survival function.{p_end}
...
{psee}
Online:  {helpb stjm11}; {helpb stjmgraph}
{p_end}
