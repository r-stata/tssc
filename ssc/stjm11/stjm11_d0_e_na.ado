...
*quietly{
	...
	/* Mata program to evaluate joint likelihood */
		mata stjm_e_na_mata$quick("`finallnf2'",st_global("surv_indlab"),y_ij,
...
mata:
	void stjm_e_na_mata(string scalar finallnf, 			// -Variable name to place likelihood contributions-
...
mata:
	void stjm_e_na_mata_quick(string scalar finallnf, 		// -Variable name to place likelihood contributions-
						string scalar s_ind, 				// -Final row per panel indicator-
						numeric matrix y_ij,	 			// -Observed longitudinal response-
						real scalar sdresidual, 			// -Current residual error estimate-
						numeric scalar N, 					// -Number of panels-
