{smcl}
{hline}
{cmd:help: {helpb lmnadnl}}{space 50} {cmd:dialog:} {bf:{dialog lmnadnl}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmnadnl: NLS Non Normality Anderson-Darling Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmnadnl##01:Syntax}{p_end}
{p 5}{helpb lmnadnl##02:Options}{p_end}
{p 5}{helpb lmnadnl##03:Description}{p_end}
{p 5}{helpb lmnadnl##04:Saved Results}{p_end}
{p 5}{helpb lmnadnl##05:References}{p_end}

{p 1}*** {helpb lmnadnl##06:Examples}{p_end}

{p 5}{helpb lmnadnl##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 3 5 6}
{cmd:lmnadnl} {depvar} {ifin} {weight} , {opt fun(expression)}{p_end} 
{p 5 5 6}
...
{pstd}
{cmd:lmnadnl} computes Non Linear Least Squares Non Normality Anderson-Darling Test.
...
{pstd}
{cmd:lmnadnl} saves the following in {cmd:e()}:
...
{stata sysuse lmnadnl.dta , clear}

{stata gen ly=ln(y)}

{stata "lmnadnl ly , fun({B0}+{B1}*k+{B2}*l)"}

{stata "lmnadnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5)"}
{hline}

. clear all
. sysuse lmnadnl.dta , clear
. gen ly=ln(y)
. lmnadnl ly, fun({B}-({H}/{R})*ln({D}*l^(-{R})+(1-{D})*k^(-{R}))) in(B 1 H 1 R 1 D 0.5)
...
==============================================================================
*** NLS Non Normality Anderson-Darling Test
==============================================================================
 Ho: Normality - Ha: Non Normality
------------------------------------------------------------------------------
- Anderson-Darling Z Test              =   0.4977     P > Z( 0.791)     0.7856
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMNADNL Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2015)}{p_end}
{p 1 10 1}{cmd:LMNADNL: "Stata Module to Compute NLS Non Normality Anderson-Darling Test"}{p_end}
