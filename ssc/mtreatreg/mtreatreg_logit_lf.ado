...
************************************************
*** ml for joint mmlogit and logit           ***
************************************************

program mtreatreg_logit_lf
	version 10.1

	scalar neqall = 2*neq + 1
	...
	tempvar lnL gi `L_xbT' xbO `L_lam' `L_h' `L_nH'
	...
	mata: mtreatreg_logit_lf("`lnL'","`G'","`H'" ///
		,"`xbTnames'","`xbO'","`lamnames'" ///
