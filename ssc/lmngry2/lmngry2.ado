...
program define lmngry2 , eclass byable(onecall)
version 11.2
...
tempname lf F K B Bx Zo FLin FLog YhLin YhLog qhiv V
...
di
di _dup(78) "{bf:{err:=}}"
di as txt "{bf:{err:*** 2SLS-IV Non Normality Geary Runs Test}}"
di _dup(78) "{bf:{err:=}}"
