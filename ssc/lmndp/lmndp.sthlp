{smcl}
{hline}
{cmd:help: {helpb lmndp}}{space 50} {cmd:dialog:} {bf:{dialog lmndp}}
{hline}

{bf:{err:{dlgtab:Title}}}

{bf:lmndp: OLS Non Normality D'Agostino-Pearson Test}

{marker 00}{bf:{err:{dlgtab:Table of Contents}}}
{p 4 8 2}

{p 5}{helpb lmndp##01:Syntax}{p_end}
{p 5}{helpb lmndp##02:Description}{p_end}
{p 5}{helpb lmndp##03:Options}{p_end}
{p 5}{helpb lmndp##04:Saved Results}{p_end}
{p 5}{helpb lmndp##05:References}{p_end}

{p 1}*** {helpb lmndp##06:Examples}{p_end}

{p 5}{helpb lmndp##07:Authors}{p_end}

{marker 01}{bf:{err:{dlgtab:Syntax}}}

{p 5 5 6}
{cmd:lmndp} {depvar} {it:{help varlist:indepvars}} {ifin} , {err: [} {opt nocons:tant} {opt coll} {err:]}{p_end}

{marker 02}{bf:{err:{dlgtab:Description}}}

{pstd}
{cmd:lmndp} computes OLS Non Normality D'Agostino-Pearson Test
...
{pstd}
{cmd:lmndp} saves the following in {cmd:e()}:
...
==============================================================================
* OLS Non Normality D'Agostino-Pearson Test
==============================================================================
 Ho: Normality - Ha: Non Normality
------------------------------------------------------------------------------
- D'Agostino-Pearson LM Test           =   0.8020     P-Value > Chi2(2) 0.6696
------------------------------------------------------------------------------
...
{bf:{err:{dlgtab:LMNDP Citation}}}

{p 1}{cmd:Shehata, Emad Abd Elmessih & Sahra Khaleel A. Mickaiel (2013)}{p_end}
{p 1 10 1}{cmd:LMNDP: "OLS Non Normality D'Agostino-Pearson Test"}{p_end}

	{browse "http://ideas.repec.org/c/boc/bocode/s457724.html"}

	{browse "http://econpapers.repec.org/software/bocbocode/s457724.htm"}
