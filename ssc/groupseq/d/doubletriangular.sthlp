...
{viewerjumpto "Syntax" “doubleTriangular##syntax"}{...}
{viewerjumpto "Description" "doubleTriangular##description"}{...}
{viewerjumpto "Options" "doubleTriangular##options"}{...}
{viewerjumpto "Remarks" "doubleTriangular##remarks"}{...}
{viewerjumpto "Examples" "doubleTriangular##examples"}{...}
{title:Title}
{phang}
{bf:doubleTriangular} {hline 2} Double Triangular Test

{marker syntax}{...}
{title:Syntax}
{p 8 17 2}
{cmdab:doubleTriangular}
[{cmd:,}
{it:options}]
...
{title:Description}
{pstd}
{cmd:doubleTriangular} determines the boundaries of, and sample size required by, a double triangular test.
...
{phang} 
{stata doubleTriangular, sigma(1)}

{phang} 
{stata doubleTriangular, l(2) delta(0.25) alpha(0.1) beta(0.1) sigma(2, 3) ratio(2) per}
