...
{viewerjumpto "Syntax" “innerWedge##syntax"}{...}
{viewerjumpto "Description" "innerWedge##description"}{...}
{viewerjumpto "Options" "innerWedge##options"}{...}
{viewerjumpto "Remarks" "innerWedge##remarks"}{...}
{viewerjumpto "Examples" "innerWedge##examples"}{...}
{title:Title}
{phang}
{bf:innerWedge} {hline 2} Group Sequential Design with the Power Family of Inner-Wedge Boundaries
...
{title:Description}
{pstd}
{cmd:innerWedge} determines the boundaries of, and sample size required by, a group sequential design with the power family of inner wedge boundaries.
...
{phang} 
{stata innerWedge, sigma(1)}

{phang} 
{stata innerWedge, l(2) delta(0.25) alpha(0.1) beta(0.1) sigma(2, 3) ratio(2) per}
